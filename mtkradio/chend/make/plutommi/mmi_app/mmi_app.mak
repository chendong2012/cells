...
ifneq ($(filter __STATIC_FC_BENGAL__, $(strip $(MODULE_DEFS))),)
SRC_LIST += plutommi\static_fc_bengal\static_fc_bengal_const.c \
						plutommi\static_fc_bengal\static_fc_bengal_interface.c \
						plutommi\static_fc_bengal\static_fc_bengal_lib.c \
						plutommi\static_fc_bengal\static_fc_bengal_ui.c
endif
...
ifneq ($(filter __MRE_PACKAGE_BASE__, $(strip $(MODULE_DEFS))),)
...
#中桓创ZHC start
ifneq ($(filter __ZHC_EJ_TTS_SUPPORT__, $(strip $(MODULE_DEFS))),)
INC_DIR += plutommi\mmi\ZhcEasyFone\ZhcEasyFoneInc \
			plutommi\mmi\ZhcEasyFone\ZhcEasyFoneSrc \
			plutommi\mmi\ZhcEasyFone\ZhcEasyFoneLib
SRC_PATH += plutommi\mmi\ZhcEasyFone\ZhcEasyFoneInc \
			plutommi\mmi\ZhcEasyFone\ZhcEasyFoneSrc \
			plutommi\mmi\ZhcEasyFone\ZhcEasyFoneLib
SRC_LIST +=plutommi\mmi\ZhcEasyFone\ZhcEasyFoneSrc\ej_common.c \
			plutommi\mmi\ZhcEasyFone\ZhcEasyFoneSrc\ej_event.c\
			plutommi\mmi\ZhcEasyFone\ZhcEasyFoneSrc\ej_fs.c\
			plutommi\mmi\ZhcEasyFone\ZhcEasyFoneSrc\ej_graphics.c\
			plutommi\mmi\ZhcEasyFone\ZhcEasyFoneSrc\ej_media.c\
			plutommi\mmi\ZhcEasyFone\ZhcEasyFoneSrc\ej_menu.c\
			plutommi\mmi\ZhcEasyFone\ZhcEasyFoneSrc\ej_nvram.c\
			plutommi\mmi\ZhcEasyFone\ZhcEasyFoneSrc\ej_nvram_adapter.c\
			plutommi\mmi\ZhcEasyFone\ZhcEasyFoneSrc\ej_phone.c\
			plutommi\mmi\ZhcEasyFone\ZhcEasyFoneSrc\ej_zlib.c\
			plutommi\mmi\ZhcEasyFone\ZhcEasyFoneSrc\ej_system_native.c\
			plutommi\mmi\ZhcEasyFone\ZhcEasyFoneSrc\ej_app_common.c\
			plutommi\mmi\ZhcEasyFone\ZhcEasyFoneSrc\ej_sms_assistant.c\
			plutommi\mmi\ZhcEasyFone\ZhcEasyFoneSrc\ej_task.c\
			plutommi\mmi\ZhcEasyFone\ZhcEasyFoneSrc\ej_socket.c\
			plutommi\mmi\ZhcEasyFone\ZhcEasyFoneSrc\ej_res_manage.c\
			plutommi\mmi\ZhcEasyFone\ZhcEasyFoneSrc\ej_tts_use.c\
			plutommi\mmi\ZhcEasyFone\ZhcEasyFoneSrc\ej_pack_manage.c\
			plutommi\mmi\ZhcEasyFone\ZhcEasyFoneSrc\ej_charge_common.c\
			plutommi\mmi\ZhcEasyFone\ZhcEasyFoneSrc\ej_wap_manager.c\
			plutommi\mmi\ZhcEasyFone\ZhcEasyFoneSrc\ej_wap_menu.c\
			plutommi\mmi\ZhcEasyFone\ZhcEasyFoneSrc\ej_app_download.c\
			plutommi\mmi\ZhcEasyFone\ZhcEasyFoneSrc\ej_app_install.c\
			plutommi\mmi\ZhcEasyFone\ZhcEasyFoneSrc\ej_main_menu.c\
			plutommi\mmi\ZhcEasyFone\ZhcEasyFoneSrc\ej_tts.c\
			plutommi\mmi\ZhcEasyFone\ZhcEasyFoneSrc\ej_tts_alarm.c\
			plutommi\mmi\ZhcEasyFone\ZhcEasyFoneSrc\ej_tts_apps.c\
			plutommi\mmi\ZhcEasyFone\ZhcEasyFoneSrc\ej_asr_command.c\
			plutommi\mmi\ZhcEasyFone\ZhcEasyFoneSrc\ej_asr_main.c\
			plutommi\mmi\ZhcEasyFone\ZhcEasyFoneSrc\ej_asr_native.c\
			plutommi\mmi\ZhcEasyFone\ZhcEasyFoneSrc\ej_asr_load.c\
			plutommi\mmi\ZhcEasyFone\ZhcEasyFoneSrc\ej_esr.c\
			plutommi\mmi\ZhcEasyFone\ZhcEasyFoneSrc\ej_esr_make_bag.c\
			plutommi\mmi\ZhcEasyFone\ZhcEasyFoneSrc\ej_esr_main.c
endif
#中桓创ZHC end
...
INC_DIR = applib\inet\engine\include \
          ...
          vendor\InputMethod\ZI\project\plutommi\v7_official_rvct\inc \
...
ifneq ($(filter __MRE_PACKAGE_BASE__, $(strip $(MODULE_DEFS))),)
INC_DIR +=	plutommi\mtkapp\MREAPP\MREAPPInc \
          plutommi\Service\MRESrv
endif

ifneq ($(filter __MMI_MRE_MSPACE__, $(strip $(MODULE_DEFS))),)
INC_DIR +=	plutommi\mtkapp\MSpace\MSpaceInc
endif
...
ifneq ($(filter __STATIC_FC_BENGAL__, $(strip $(MODULE_DEFS))),)
	INC_DIR += plutommi\static_fc_bengal
						 
	SRC_PATH += plutommi\static_fc_bengal
endif
...
ifneq ($(filter __EASY_FONE_SUPPORT__, $(strip $(MODULE_DEFS))),)
INC_DIR += plutommi\mmi\EasyFone\EasyFoneInc \
			plutommi\mmi\EasyFone\EasyFoneSrc
SRC_PATH += plutommi\mmi\EasyFone\EasyFoneInc \
			plutommi\mmi\EasyFone\EasyFoneSrc \
			plutommi\mmi\EasyFone\EasyFoneLib 
SRC_LIST += plutommi\mmi\EasyFone\EasyFoneSrc\ej_common.c \
			plutommi\mmi\EasyFone\EasyFoneSrc\ej_event.c\
			plutommi\mmi\EasyFone\EasyFoneSrc\ej_fs.c\
			plutommi\mmi\EasyFone\EasyFoneSrc\ej_graphics.c\
			plutommi\mmi\EasyFone\EasyFoneSrc\ej_main_menu.c\
			plutommi\mmi\EasyFone\EasyFoneSrc\ej_media.c\
			plutommi\mmi\EasyFone\EasyFoneSrc\ej_menu.c\
			plutommi\mmi\EasyFone\EasyFoneSrc\ej_nvram.c\
			plutommi\mmi\EasyFone\EasyFoneSrc\ej_nvram_adapter.c\
			plutommi\mmi\EasyFone\EasyFoneSrc\ej_phone.c\
			plutommi\mmi\EasyFone\EasyFoneSrc\ej_zlib.c\
			plutommi\mmi\EasyFone\EasyFoneSrc\ej_system_native.c\
			plutommi\mmi\EasyFone\EasyFoneSrc\ej_app_common.c\
			plutommi\mmi\EasyFone\EasyFoneSrc\ej_sms_assistant.c\
			plutommi\mmi\EasyFone\EasyFoneSrc\ej_task.c\
			plutommi\mmi\EasyFone\EasyFoneSrc\ej_tts.c\
			plutommi\mmi\EasyFone\EasyFoneSrc\ej_tts_alarm.c\
			plutommi\mmi\EasyFone\EasyFoneSrc\ej_tts_apps.c\
			plutommi\mmi\EasyFone\EasyFoneSrc\ej_tts_use.c\
			plutommi\mmi\EasyFone\EasyFoneSrc\ej_esr.c\
			plutommi\mmi\EasyFone\EasyFoneSrc\ej_esr_main.c\
			plutommi\mmi\EasyFone\EasyFoneSrc\ej_socket.c\
			plutommi\mmi\EasyFone\EasyFoneSrc\ej_res_manage.c\
			plutommi\mmi\EasyFone\EasyFoneSrc\ej_asr_native.c\
			plutommi\mmi\EasyFone\EasyFoneSrc\ej_asr_main.c\
			plutommi\mmi\EasyFone\EasyFoneSrc\ej_asr_command.c\
			plutommi\mmi\EasyFone\EasyFoneSrc\ej_wap_menu.c\
			plutommi\mmi\EasyFone\EasyFoneSrc\ej_magicvoice_main.c \
			plutommi\mmi\EasyFone\EasyFoneSrc\ej_magicvoice_wrap.c \
			plutommi\mmi\EasyFone\EasyFoneSrc\ej_voice_bridge.c \
			plutommi\mmi\EasyFone\EasyFoneSrc\ej_voice_misc.c \
			plutommi\mmi\EasyFone\EasyFoneSrc\ej_voice_ndate.c \
			plutommi\mmi\EasyFone\EasyFoneSrc\ej_voice_pdate.c \
			plutommi\mmi\EasyFone\EasyFoneSrc\ej_voice_scfg.c \
			plutommi\mmi\EasyFone\EasyFoneSrc\ej_voice_sdate.c \
			plutommi\mmi\EasyFone\EasyFoneSrc\ej_voice_system.c 
endif
ifneq ($(filter __ZZ_SALE_MTK__, $(strip $(MODULE_DEFS))),)
SRC_PATH += plutommi\mmi\zsale\external\src
INC_DIR += plutommi\mmi\zsale\external\inc  
SRC_LIST += plutommi\mmi\zsale\external\src\zzs_port.c
SRC_LIST += plutommi\mmi\zsale\external\src\zzs_adapter.c
SRC_LIST += plutommi\mmi\zsale\external\src\zzs_kernal_adp.c
endif
ifneq ($(filter __SKY_3DGUI__, $(strip $(MODULE_DEFS))),)
SRC_LIST += plutommi\mmi\Mythroad\SkyUI\Adaptation\Src\MTK\ATS_debug.c			\
			plutommi\mmi\Mythroad\SkyUI\Adaptation\Src\MTK\ATS_LCD.c			\
			plutommi\mmi\Mythroad\SkyUI\Adaptation\Src\MTK\ATS_memory.c			\
			plutommi\mmi\Mythroad\SkyUI\Adaptation\Src\MTK\ATS_timer.c			\
			plutommi\mmi\Mythroad\SkyUI\Adaptation\Src\MTK\ATS_entry.c			\
			plutommi\mmi\Mythroad\SkyUI\Adaptation\Src\MTK\ATS_FS.c			\
			plutommi\mmi\Mythroad\SkyUI\Adaptation\Src\MTK\ATS_image.c			\
			plutommi\mmi\Mythroad\SkyUI\Adaptation\Src\MTK\ATS_key.c			\
			plutommi\mmi\Mythroad\SkyUI\Adaptation\Src\MTK\ATS_LCD.c			\
			plutommi\mmi\Mythroad\SkyUI\Adaptation\Src\MTK\ATS_string.c			\
			plutommi\mmi\Mythroad\SkyUI\Adaptation\Src\MTK\ATS_system.c			\
			plutommi\mmi\Mythroad\SkyUI\Adaptation\Src\MTK\ATS_touch.c			\
			plutommi\mmi\Mythroad\SkyUI\Adaptation\Src\MTK\ATS_softkey_bar.c			\
			plutommi\mmi\Mythroad\SkyUI\Adaptation\Src\MTK\ATS_status_bar.c			\
			plutommi\mmi\Mythroad\SkyUI\Adaptation\Src\MTK\ATS_accelerator.c			\
			plutommi\mmi\Mythroad\SkyUI\Adaptation\Src\MTK\ATS_media.c			\
			plutommi\mmi\Mythroad\SkyUI\Adaptation\Src\MTK\ATS_text.c			\
			plutommi\mmi\Mythroad\SkyUI\Control\Interface\MTK\Src\ATS_MTK_gui.c			\
			plutommi\mmi\Mythroad\SkyUI\Control\Interface\MTK\Src\ATS_MTK_fs.c			\
			plutommi\mmi\Mythroad\SkyUI\Control\AnimCtrl\Controls\Src\ATS_ctrl_clover_config.c			\
			plutommi\mmi\Mythroad\SkyUI\Control\AnimCtrl\Controls\Src\ATS_ctrl_le_unlocker_config.c			\
			plutommi\mmi\Mythroad\SkyUI\animation\Src\SKY_Animation_config.c			\
			plutommi\mmi\Mythroad\SkyUI\dsmModule\SDownload\Src\SDL_adapter.c			\
			plutommi\mmi\Mythroad\SkyUI\dsmModule\SWeather\Src\SWea_config.c		\
			plutommi\mmi\Mythroad\SkyUI\skf\skf_port\src\skf_port.c

INC_DIR += plutommi\mmi\Mythroad\SkyUI\Adaptation\Inc		\
			plutommi\mmi\Mythroad\SkyUI\Control\Interface\MTK\Inc		\
			plutommi\mmi\Mythroad\SkyUI\Control\Common\Inc		\
			plutommi\mmi\Mythroad\SkyUI\Control\Glayer\Inc		\
			plutommi\mmi\Mythroad\SkyUI\Control\AnimCtrl\Common\Inc		\
			plutommi\mmi\Mythroad\SkyUI\Control\AnimCtrl\Controls\Inc		\
			plutommi\mmi\Mythroad\SkyUI\Animation\Inc		\
			plutommi\mmi\Mythroad\SkyUI\GraphicLib		\
			plutommi\mmi\Mythroad\SkyUI\interface\Inc		\
			plutommi\mmi\Mythroad\SkyUI\dsmModule\SDownload\Inc		\
			plutommi\mmi\Mythroad\SkyUI\dsmModule\SWeather\Inc		\
			plutommi\mmi\Mythroad\SkyUI\skf\common\inc		\
			plutommi\mmi\Mythroad\SkyUI\skf\skf_api\inc		\
			plutommi\mmi\Mythroad\SkyUI\skf\skf_port\inc
			
SRC_PATH += plutommi\mmi\Mythroad\SkyUI\Adaptation\Src\MTK		\
			plutommi\mmi\Mythroad\SkyUI\Control\Interface\MTK\Src		\
			plutommi\mmi\Mythroad\SkyUI\Control\AnimCtrl\Controls\Src		\
			plutommi\mmi\Mythroad\SkyUI\Animation\Src		\
			plutommi\mmi\Mythroad\SkyUI\dsmModule\SDownload\Src		\
			plutommi\mmi\Mythroad\SkyUI\dsmModule\SWeather\Src		\
			plutommi\mmi\Mythroad\SkyUI\skf\skf_port\src
ifneq ($(filter __SKY_3DGUI_MAGIC_MAINMENU__ , $(strip $(MODULE_DEFS))),)  
	SRC_LIST += plutommi\mmi\Mythroad\SkyUI\mainmenu\src\SKY_mainmenu_config.c
	INC_DIR += plutommi\mmi\Mythroad\SkyUI\mainmenu\inc
	SRC_PATH += plutommi\mmi\Mythroad\SkyUI\mainmenu\src
endif
endif
