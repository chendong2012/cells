...
#if defined(__MMI_HUMAN_VOICE_MAINMENU_TONE__)
#include "mmi_rp_srv_prof_def.h"
#include "profilessrvgprot.h"
#include "custom_srv_prof_defs.h"
#include "mdi_audio.h"
#endif
#ifdef __BST_USER_HIDE_MENU__ //add by YZHD 20130725 用户设置隐藏菜单功能 Block Function
#include "mmi_rp_app_profiles_def.h"
extern U8 gHidemessage;
extern U8 gHidephonebook;
extern U8 gHideorganize;
extern U8 gHidemultimedia;
extern U8 gHidecallcenter;
extern void ReadvalueFromNvram(void);
#endif
...
void goto_homepage(void){};
void highlight_mainmenu_monwap(void){}
#endif /* __MMI_OP01_MENU_9MATRIX__ & WAP_SUPPORT */

#if defined(__OP02__)
void goto_online_sales(void){}
void highlight_mainmenu_online_sales(void){}
void call_116114(void){}
void mmi_op02_midlet_116114_launch(void){}
void mmi_op02_midlet_wo_store_launch(void){}
void mmi_op02_midlet_push_mail_launch(void){}
void mmi_op02_midlet_mobile_music_launch(void){}
void mmi_op02_midlet_mobile_tv_launch(void){}
void highlight_mainmenu_116114(void){}
void highlight_mainmenu_mobile_tv(void){}{}
void highlight_mainmenu_mobile_music(void){}
void highlight_mainmenu_pushmail(void){}
void highlight_mainmenu_mobile_stock(void){}
#endif /* __OP02_*/
...
void highlight_mainmenu_mobile_tv_cmmb(void){}
#endif
#ifdef __MMI_139_PUSH_MAIL__
void highlight_mainmenu_139mail(void){}
#endif
#ifdef __MMI_MOBILE_VIDEO__
void highlight_mainmenu_mobile_video(void){}
#endif
#ifdef BROWSER_SUPPORT
void goto_op01_online_sales(void){}
#endif
void highlight_mainmenu_10086(void){}
void highlight_mainmenu_monternet(void){}
void highlight_mainmenu_music(void){}
void highlight_mainmenu_fetion(void){}
void highlight_mainmenu_mobile_stock(void){}
void highlight_mainmenu_mobile_map(void){}
void highlight_mainmenu_mobile_market(void){}
void highlight_mainmenu_mobile_reader(void){}
#endif /* __OP01__ */
...
#ifdef __OP02_0200__
void highlight_mainmenu_WO3G(void){}
void highlight_mainmenu_WOSTORE(void){}
void highlight_mainmenu_usim_app(void){}
void highlight_mainmenu_wo_read(void){}
#ifdef BROWSER_SUPPORT
void goto_op02_web_portal(void){}
void goto_wo_read(void){}
void highlight_mainmenu_internet(void){}
#endif
#endif /* __OP02_0200__ */

#ifdef __MMI_OP02_LEMEI__
void highlight_mainmenu_LEMEI(void){}

#endif

#if defined(__OP01_FWPBW__)
void mmi_entry_stk_application_scr(void){}
void highlight_mainmenu_STK(void){}
...
#define SMS_PREDEFINE_NUMBER		"10010"
...
static S8 Hotline_number[14]={0x31,0x00,0x31,0x00,0x36,0x00,0x31,0x00,0x31,0x00,0x34,0x00,0x00,0x00};
#endif
...
#if (defined(__BYT_BASE_MD__) || defined(__60D_BYT_BASE_MD__))&&!defined(__MMI_DSM_NEW__)||defined(__A76_ZKN_240x320__)||defined(__G96_60M_SF_WAIWEN__)||defined(__A8_MIGE_A31_60M_ESVB__) //modify by YZHD 20130524
...
#endif
#if defined(__60M_128x160_ZX001__)
extern void mmi_game_entry_app_screen(void);
#endif
...
void highlight_mainmenu_funandgames(void)
{
    ...
    //SetRightSoftkeyFunction(handle_mainmenu_right_softkey_up, KEY_EVENT_UP);
#if (defined(__BYT_BASE_MD__) || defined(__60D_BYT_BASE_MD__))&&!defined(__MMI_DSM_NEW__)||defined(__A76_ZKN_240x320__) ||defined(__G96_60M_SF_WAIWEN__)||defined(__A8_MIGE_A31_60M_ESVB__)//modify by YZHD 20130524
    set_main_menu_softkey_handler(mmi_game_entry_app_screen, handle_mainmenu_right_softkey_up);
#else
#if defined(__60M_128x160_ZX001__) || defined(__60M_128x160__)//(20140415)直接进入游戏菜单界面lj
    set_main_menu_softkey_handler(mmi_game_entry_app_screen, handle_mainmenu_right_softkey_up);//mmi_fng_entry_screen
#else
...
void highlight_mainmenu_monwap(void)
{
    ...
    set_main_menu_softkey_handler(goto_mobile_suite_screen, handle_mainmenu_right_softkey_up);
#else
...
void goto_homepage(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
   //wap_start_browser(WAP_BROWSER_GOTO_URL, (PU8)MMI_OP02_HOMEPAGE);	
...
void highlight_mainmenu_monwap(void)
{
    ...
    SetLeftSoftkeyFunction(goto_homepage, KEY_EVENT_UP);
    SetCenterSoftkeyFunction(goto_homepage, KEY_EVENT_UP); 
    SetRightSoftkeyFunction(handle_mainmenu_right_softkey_up, KEY_EVENT_UP);
}
...
void goto_online_sales(void)
{
    ...
    sendData.flag = MMI_SMS_SMS_ENTRY_WRITE_REPLY;
    sendData.ascii_addr = SMS_PREDEFINE_NUMBER;
...
/*****************************************************************************
 * FUNCTION
 *  highlight_mainmenu_online_sales
 * DESCRIPTION
 *  Hilite Handler for Online Sales Menu
 * PARAMETERS
 *  void
 * RETURNS
 *  void
...
void highlight_mainmenu_online_sales(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    set_main_menu_softkey_handler(goto_online_sales, handle_mainmenu_right_softkey_up);
} 
...
void call_116114(void)
{
    ...
    {
        mmi_popup_display_simple((WCHAR*)GetString(STR_GLOBAL_CURRENTLY_NOT_AVAILABLE), MMI_EVENT_FAILURE, GRP_ID_ROOT, NULL);
        return;
    }
...
void mmi_op02_midlet_116114_launch(void)
{
    ...
    mmi_java_launch_midlet((kal_char*)L"J0000001");
#endif
...
/*****************************************************************************
 * FUNCTION
 *  mmi_op02_midlet_wo_store_launch
 * DESCRIPTION
 *
 * PARAMETERS
 *  void
...
void mmi_op02_midlet_wo_store_launch(void)
{
    mmi_java_launch_midlet((kal_char*)L"J0000002");
}


/*****************************************************************************
 * FUNCTION
 *  mmi_op02_midlet_pushmail_launch
 * DESCRIPTION
 *
 * PARAMETERS
 *  void
...
void mmi_op02_midlet_push_mail_launch(void)
{
    mmi_java_launch_midlet((kal_char*)L"J0000003");
}


/*****************************************************************************
 * FUNCTION
 *  mmi_op02_midlet_music_launch
 * DESCRIPTION
 *
 * PARAMETERS
 *  void
...
void mmi_op02_midlet_mobile_music_launch(void)
{
    mmi_java_launch_midlet((kal_char*)L"J0000004");
}


/*****************************************************************************
 * FUNCTION
 *  mmi_op02_midlet_mobile_tv_launch
 * DESCRIPTION
 *
 * PARAMETERS
 *  void
...
void mmi_op02_midlet_mobile_tv_launch(void)
{
    mmi_java_launch_midlet((kal_char*)L"J0000005");
}


/*****************************************************************************
 * FUNCTION
 *  highlight_mainmenu_116114
 * DESCRIPTION
 *  Hilite Handler for 116114 Menu
 * PARAMETERS
 *  void
 * RETURNS
 *  void
...
void highlight_mainmenu_116114(void)
{
    ...
    /*----------------------------------------------------------------*/
#ifdef __MMI_OP02_MIDLET_116114__
    set_main_menu_softkey_handler(mmi_op02_midlet_116114_launch, handle_mainmenu_right_softkey_up);
#else
    set_main_menu_softkey_handler(NULL, handle_mainmenu_right_softkey_up);
#endif
}
...
/*****************************************************************************
 * FUNCTION
 *  highlight_mainmenu_mobile_tv
 * DESCRIPTION
 *  Hilite Handler for Mobile TV Menu
 * PARAMETERS
 *  void
 * RETURNS
 *  void
...
void highlight_mainmenu_mobile_tv(void)
{
    ...
    set_main_menu_softkey_handler(mmi_op02_midlet_mobile_tv_launch, handle_mainmenu_right_softkey_up);
#else
    set_main_menu_softkey_handler(NULL, handle_mainmenu_right_softkey_up);
#endif
}
...
/*****************************************************************************
 * FUNCTION
 *  highlight_mainmenu_mobile_music
 * DESCRIPTION
 *  Hilite Handler for Mobile music Menu
 * PARAMETERS
 *  void
 * RETURNS
 *  void
...
void highlight_mainmenu_mobile_music(void)
{
    ...
    set_main_menu_softkey_handler(mmi_op02_midlet_mobile_music_launch, handle_mainmenu_right_softkey_up);
#else
    set_main_menu_softkey_handler(NULL, handle_mainmenu_right_softkey_up);
#endif
}
...
/*****************************************************************************
 * FUNCTION
 *  highlight_mainmenu_pushmail
 * DESCRIPTION
 *  Hilite Handler for PushMail Menu
 * PARAMETERS
 *  void
 * RETURNS
 *  void
...
void highlight_mainmenu_pushmail(void)
{
    ...
    set_main_menu_softkey_handler(mmi_op02_midlet_push_mail_launch, handle_mainmenu_right_softkey_up);
#else
    set_main_menu_softkey_handler(NULL, handle_mainmenu_right_softkey_up);
#endif
}
...
/*****************************************************************************
 * FUNCTION
 *  highlight_mainmenu_mobile_stock
 * DESCRIPTION
 *  Hilite Handler for Mobile Stock Menu
 * PARAMETERS
 *  void
 * RETURNS
 *  void
...
#if defined(__L39_60M_B07_160x128_MMI__)//YZHD 20130726 子菜单按数字键可以进入对应下级目录
extern U32 max_menu_number;//子菜单最大菜单数 也就是允许操作的最大数
/*****************************************************************************
 * FUNCTION
 *  sub_menu_shortcut_executer
 * DESCRIPTION
 ...
 *  void
 *****************************************************************************/
void sub_menu_shortcut_executer(S32 index)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    if (index >= 0 && index < max_menu_number)
    {
...
#if !defined(__L39_60M_B07_160x128_MMI__)//YZHD 20130726 主菜单按数字键可以进入对应下级目录
    if (MMI_current_menu_type == PAGE_MENU)
    {
        return;
    }
...
#if defined(__MMI_HUMAN_VOICE_MAINMENU_TONE__)
extern U8 gMainMenuVoiceFlag;
static void PlayMainMenuItemText(S32 index)
{ 
     /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
	...
	srv_prof_play_req_struct_init(&play_req, VOICE_TONE);
	 play_req.audio_id =AUD_ID_PROF_MM_BEGIN+index +1;
	play_req.play_style = SRV_PROF_RING_TYPE_ONCE;
	play_req.volume = volume;
	play_req.tone_type = VOICE_TONE;
	...
	{
		kal_prompt_trace(MOD_IDLE, "PlayMainMenuItemText fail");
	}
...
#if defined(__MMI_HUMAN_VOICE_MAINMENU_TONE__)
	if(gMainMenuVoiceFlag)
		PlayMainMenuItemText(index);
#endif
...
#endif
#ifdef __SKY_3DGUI_MAGIC_MAINMENU__
	aniParticle_SetAniPos_menu(index);
#endif
}
...
#if defined(__L39_60m_220x176_MMI__)||defined(__L39_60m_KT_220x176_MMI__)||defined(__L39_60m_COMMON_220x176_MMI__)
    HighlightMenu = 0;
#endif
#if defined(__L39_160X128_YST__)||defined(__L39_SL_200__)||defined(__F303_YST_F12__)||defined(__G96_60M_SF_WAIWEN__)||defined(__A8_MIGE_A31_60M_ESVB__)//songfeng  主菜单顺序和资源里第一个对应
    HighlightMenu=0;
#endif
...
#if defined(__STATIC_FC_BENGAL__)
extern void static_fc_bengal_main_entry(void);
void mmi_josh_sms_zone_menu_highlight(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    SetLeftSoftkeyFunction(static_fc_bengal_main_entry, KEY_EVENT_UP);
    SetRightSoftkeyFunction(GoBackHistory, KEY_EVENT_UP);
}
#endif
/*****************************************************************************
...
#if defined(__L39_APS_GERMAN_VERSION__)//YZHD 20131224 德国版本主菜单通话记录
...
void mmi_main_menu_entry(void)
{
	...
	ReadvalueFromNvram();
        if(1==gHidephonebook)
            mmi_frm_hide_menu_item(MAIN_MENU_PHONEBOOK_MENUID);
        else
            mmi_frm_unhide_menu_item(MAIN_MENU_PHONEBOOK_MENUID);

        if(1==gHidemessage)
            mmi_frm_hide_menu_item(MAIN_MENU_MESSAGES_MENUID);
        else
            mmi_frm_unhide_menu_item(MAIN_MENU_MESSAGES_MENUID);


#if defined(__L39_APS_GERMAN_VERSION__)//YZHD 20131224 德国版本主菜单通话记录
        if(1==gHidecallcenter)
        {
            mmi_frm_hide_menu_item(MAIN_MENU_CALL_LOG);
        }
        else
        {
            mmi_frm_unhide_menu_item(MAIN_MENU_CALL_LOG);
        }
        if(1==gHidemultimedia)
        {
            mmi_frm_hide_menu_item(MENU_ID_FMRDO_MAIN);
        }
        else
        {
            mmi_frm_unhide_menu_item(MENU_ID_FMRDO_MAIN);
        }
#else
        if(1==gHidecallcenter)
        {
            mmi_frm_hide_menu_item(MAIN_MENU_CALL_CENTER);
        }
        else
        {
            mmi_frm_unhide_menu_item(MAIN_MENU_CALL_CENTER);
        }
        if(1==gHidemultimedia)
        {
        ...
        if(1==gHideorganize)
            mmi_frm_hide_menu_item(MAIN_MENU_ORGANIZER_MENUID);
        else
            mmi_frm_unhide_menu_item(MAIN_MENU_ORGANIZER_MENUID);       
    #endif    
    ...
    SetRightSoftkeyFunction(mmi_frm_scrn_close_active_id, KEY_EVENT_UP);
		...
		{	
			...
			aniParticle_StartAniIdle_menu(MMI_fixed_matrix_menu.highlighted_item);
		}
#endif		
}
...
#endif
	#ifdef __SKY_3DGUI_MAGIC_MAINMENU__
	aniParticle_StopAni_menu();
#endif
#ifdef __BESTONE_MAIN_MENU_ITEM_EFFECT__
    gfMenuItemEffectDestroy();
#endif
...
void highlight_mainmenu_Camera(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
	set_main_menu_softkey_handler(EntryMainCamera, handle_mainmenu_right_softkey_up);
}
...
static void mmi_entry_main_tools_screen(void)
{
    ...
    {
        mmi_frm_hide_menu_item(EXTRA_SHORTCUTS_MENUID);
    }
    else
    {
        mmi_frm_unhide_menu_item(EXTRA_SHORTCUTS_MENUID);
    }
#endif
#endif /* __DISABLE_SHORTCUTS_MENU__ */

    guiBuffer = mmi_frm_scrn_get_active_gui_buf();
    nItems = GetNumOfChild_Ext(MAIN_MENU_TOOLS_MENUID);
    GetSequenceStringIds_Ext(MAIN_MENU_TOOLS_MENUID, ItemList);
    GetSequenceImageIds_Ext(MAIN_MENU_TOOLS_MENUID, ItemIcons);
    SetParentHandler(MAIN_MENU_TOOLS_MENUID);
    ...
    if (nItems == 0)
    {
        ShowCategory52Screen(
            ...
            GetRootTitleIcon(MAIN_MENU_TOOLS_MENUID),
            0,
            0,
            STR_GLOBAL_BACK,
            IMG_GLOBAL_BACK,
...
static mmi_id g_media_no_sim_group_id;
static void mmi_entry_main_media_no_sim_screen(void);
/*****************************************************************************
 * FUNCTION
...
void EntryMainMultimediaNoSim(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
     g_media_no_sim_group_id = mmi_frm_group_create(GRP_ID_ROOT, GRP_ID_AUTO_GEN, mmi_main_submenu_proc, NULL);
     mmi_frm_group_enter(g_media_no_sim_group_id, MMI_FRM_NODE_SMART_CLOSE_FLAG);
     mmi_entry_main_media_no_sim_screen();
}
...
static void mmi_entry_main_media_no_sim_screen(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    if(mmi_frm_scrn_enter(g_media_no_sim_group_id, SCR_MMEDIA, NULL, mmi_entry_main_media_no_sim_screen, MMI_FRM_FULL_SCRN) == MMI_FALSE)
    {
        return;
    }
...
void mmi_entry_main_multimedia_screen(void)
{
	...
	//wangshengyuan add 20121220.
    #if defined(__POWER_SAVE_PROFILES__)&&defined(__STOP_MEDIA_APPLITION__) //wangshengyuan add for power save profile
    if(IsPowerSaveActivated())
    {
    	mmi_popup_display_simple((WCHAR*)GetString(STR_GLOBAL_POWERSAVE_WARNING), 
    		MMI_EVENT_WARNING, 
    		GRP_ID_ROOT, 
    		NULL);		
    	return;
...
#if defined( __MMI_OP11_MENU_12MATRIX__) || defined( __MMI_OP12_MENU_12MATRIX__)
static mmi_id g_camera_group_id;
static void mmi_entry_main_camera_screen(void);

static void mmi_main_camera_highlight_hdlr(S32 index)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
...
void EntryMainCamera(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
     g_camera_group_id = mmi_frm_group_create(GRP_ID_ROOT, GRP_ID_AUTO_GEN, mmi_main_submenu_proc, NULL);
     mmi_frm_group_enter(g_camera_group_id, MMI_FRM_NODE_SMART_CLOSE_FLAG);
     mmi_entry_main_camera_screen();
}
...
static void mmi_entry_main_camera_screen(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    if(mmi_frm_scrn_enter(g_camera_group_id, SCR_CAMERA, NULL, mmi_entry_main_camera_screen, MMI_FRM_FULL_SCRN) == MMI_FALSE)
    {
        return;
    }
...
#if defined(__MMI_FM_RADIO__) 
    RegisterHighlightHandler(mmi_main_camera_highlight_hdlr);
    nItems = mmi_fmrdo_check_chip_or_hide(nItems, ItemList, ItemIcons);
#else /* defined(__MMI_FM_RADIO__) */ 
    RegisterHighlightHandler(mmi_main_camera_highlight_hdlr);
#endif /* defined(__MMI_FM_RADIO__) */ 
...
/*****************************************************************************
 * FUNCTION
 *  highlight_mainmenu_mobile_tv_cmmb
 * DESCRIPTION
 *  Associate the key handler
 *  with left and rt soft key
 * PARAMETERS
...
void highlight_mainmenu_mobile_tv_cmmb(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    set_main_menu_softkey_handler(mmi_dtv_player_launch, handle_mainmenu_right_softkey_up);
}
#endif
...
void highlight_mainmenu_139mail(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    set_main_menu_softkey_handler(PushMail_MMI_Entry, handle_mainmenu_right_softkey_up);
}
#endif
...
/*****************************************************************************
 * FUNCTION
 *  highlight_mainmenu_mobile_video
 * DESCRIPTION
 *  Associate the key handler
 *  with left and rt soft key
 * PARAMETERS
...
void highlight_mainmenu_mobile_video(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    set_main_menu_softkey_handler(mmi_mobilevideo_launch, handle_mainmenu_right_softkey_up);
}
#endif
...
/*****************************************************************************
 * FUNCTION
 *  goto_op01_online_sales
 * DESCRIPTION
 *  goto online sales for OP01
 * PARAMETERS
 *  void
 * RETURNS
 *  void
...
void highlight_mainmenu_10086(void)
{
    ...
    /*----------------------------------------------------------------*/
#ifdef BROWSER_SUPPORT
    set_main_menu_softkey_handler(goto_op01_online_sales, handle_mainmenu_right_softkey_up);
#else
    set_main_menu_softkey_handler(NULL, handle_mainmenu_right_softkey_up);
#endif
}
...
#ifdef BROWSER_SUPPORT
  #ifdef __MMI_VUI_SHELL_OP01_HOMESCREEN__
    set_main_menu_softkey_handler(vadp_v2p_op01_hs_start_homepage_by_cmwap, handle_mainmenu_right_softkey_up);
  #else
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
...
void highlight_mainmenu_music(void)
{
    ...
    extern void vadp_v2p_hs_op01_midlet_launch_music(void);

    /*----------------------------------------------------------------*/
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    set_main_menu_softkey_handler(vadp_v2p_hs_op01_midlet_launch_music, handle_mainmenu_right_softkey_up);
#else
    set_main_menu_softkey_handler(NULL, handle_mainmenu_right_softkey_up);
#endif
}
...
void highlight_mainmenu_fetion(void)
{
    ...
    extern void vadp_v2p_hs_op01_midlet_launch_fetion(void);

    /*----------------------------------------------------------------*/
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    set_main_menu_softkey_handler(vadp_v2p_hs_op01_midlet_launch_fetion, handle_mainmenu_right_softkey_up);
#else
    set_main_menu_softkey_handler(NULL, handle_mainmenu_right_softkey_up);
#endif
}
...
void highlight_mainmenu_mobile_stock(void)
{
    ...
    extern void vadp_v2p_hs_op01_midlet_launch_stock(void);

    /*----------------------------------------------------------------*/
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    set_main_menu_softkey_handler(vadp_v2p_hs_op01_midlet_launch_stock, handle_mainmenu_right_softkey_up);
#else
    set_main_menu_softkey_handler(NULL, handle_mainmenu_right_softkey_up);
#endif
}
...
void highlight_mainmenu_mobile_map(void)
{
    ...
    extern void vadp_v2p_hs_op01_midlet_launch_map(void);

    /*----------------------------------------------------------------*/
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    set_main_menu_softkey_handler(vadp_v2p_hs_op01_midlet_launch_map, handle_mainmenu_right_softkey_up);
#else
    set_main_menu_softkey_handler(NULL, handle_mainmenu_right_softkey_up);
#endif
}
...
/*****************************************************************************
 * FUNCTION
 *  highlight_mainmenu_mobile_market
 * DESCRIPTION
 *  Associate the key handler
 *  with left and rt soft key
 * PARAMETERS
...
void highlight_mainmenu_mobile_market(void)
{
    ...
    extern void vadp_v2p_hs_op01_midlet_launch_mm(void);

    /*----------------------------------------------------------------*/
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    set_main_menu_softkey_handler(vadp_v2p_hs_op01_midlet_launch_mm, handle_mainmenu_right_softkey_up);
#else
    set_main_menu_softkey_handler(NULL, handle_mainmenu_right_softkey_up);
#endif
}
...
/*****************************************************************************
 * FUNCTION
 *  highlight_mainmenu_mobile_reader
 * DESCRIPTION
 *  Associate the key handler
 *  with left and rt soft key
 * PARAMETERS
...
void highlight_mainmenu_mobile_reader(void)
{
    ...
    extern void vadp_v2p_hs_op01_midlet_launch_cmread(void);

    /*----------------------------------------------------------------*/
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    set_main_menu_softkey_handler(vadp_v2p_hs_op01_midlet_launch_cmread, handle_mainmenu_right_softkey_up);
#else
    set_main_menu_softkey_handler(NULL, handle_mainmenu_right_softkey_up);
#endif
}
...
void highlight_mainmenu_WO3G(void)
{
    ...
    /*----------------------------------------------------------------*/
#ifdef BROWSER_SUPPORT
    set_main_menu_softkey_handler(goto_op02_web_portal, handle_mainmenu_right_softkey_up);
#else
    set_main_menu_softkey_handler(NULL, handle_mainmenu_right_softkey_up);
#endif
}
...
void highlight_mainmenu_WOSTORE(void)
{
    ...
    set_main_menu_softkey_handler(mmi_op02_midlet_wo_store_launch, handle_mainmenu_right_softkey_up);
#else
    set_main_menu_softkey_handler(NULL, handle_mainmenu_right_softkey_up);
#endif
}
...
/*****************************************************************************
 * FUNCTION
 *  highlight_mainmenu_wo_read
 * DESCRIPTION
 *  Hilite Handler for WO read Menu
 * PARAMETERS
 *  void
 * RETURNS
 *  void
...
void highlight_mainmenu_wo_read(void)
{
    ...
    /*----------------------------------------------------------------*/
#ifdef BROWSER_SUPPORT
    set_main_menu_softkey_handler(goto_wo_read, handle_mainmenu_right_softkey_up);
#else
    set_main_menu_softkey_handler(NULL, handle_mainmenu_right_softkey_up);
#endif
}
...
/*****************************************************************************
 * FUNCTION
 *  highlight_mainmenu_internet
 * DESCRIPTION
 *  Hilite Handler for internet Menu
 * PARAMETERS
 *  void
 * RETURNS
 *  void
...
void highlight_mainmenu_LEMEI(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    set_main_menu_softkey_handler(EntryLemeiMain, handle_mainmenu_right_softkey_up);
}
...
void highlight_mainmenu_STK(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    set_main_menu_softkey_handler(mmi_entry_stk_application_scr, handle_mainmenu_right_softkey_up);
}
#endif /* defined(__OP01_FWPBW__) */
...
#if defined(__KENUO_PARADISE__)
void entry_kenuo_paradise_show(mmi_menu_id menu_id)
{
    U16 title = NULL;
    U16 message = NULL;
    U8 *gui_buffer = NULL;
    ...
    if (!mmi_frm_scrn_enter(
        GRP_ID_KENUO_PARADISE,
        SCR_ID_KENUO_PARADISE,
        NULL,
        entry_kenuo_paradise_show,
        MMI_FRM_FULL_SCRN))
    {
        return;
    }
    ...
    switch (menu_id)
    {
        case SBU_MENU_KENUO_HEADQUARTERS_ADDRESS:
            title = STR_ID_KENUO_HEADQUARTERS_ADDRESS;
            message = STR_ID_KENUO_HEADQUARTERS_ADDRESS_INFO;
            break;
        case SBU_MENU_KENUO_PRODUCT:
            title = STR_ID_KENUO_PRODUCT;
            message = STR_ID_KENUO_PRODUCT_INFO;
            break;
        case SBU_MENU_JIANGSU:
            title = STR_ID_JIANGSU;
            message = STR_ID_JIANGSU_INFO;
            break;
        case SBU_MENU_FUJIAN:
            title = STR_ID_FUJIAN;
            message = STR_ID_FUJIAN_INFO;
            break;
        case SBU_MENU_SHANGHAI:
            title = STR_ID_SHANGHAI;
            message = STR_ID_SHANGHAI_INFO;
            break;
        case SBU_MENU_HUNAN:
            title = STR_ID_HUNAN;
            message = STR_ID_HUNAN_INFO;
            break;
        case SBU_MENU_SHANDONG:
            title = STR_ID_SHANDONG;
            message = STR_ID_SHANDONG_INFO;
            break;
        case SBU_MENU_HENAN:
            title = STR_ID_HENAN;
            message = STR_ID_HENAN_INFO;
            break;
        case SBU_MENU_SICHUAN:
            title = STR_ID_SICHUAN;
            message = STR_ID_SICHUAN_INFO;
            break;
        case SBU_MENU_YUNAN:
            title = STR_ID_YUNAN;
            message = STR_ID_YUNAN_INFO;
            break;
        case SBU_MENU_GUIZHOU:
            title = STR_ID_GUIZHOU;
            message = STR_ID_GUIZHOU_INFO;
            break;
        case SBU_MENU_CHONGQING:
            title = STR_ID_CHONGQING;
            message = STR_ID_CHONGQING_INFO;
            break;
        case SBU_MENU_GANSU:
            title = STR_ID_GANSU;
            message = STR_ID_GANSU_INFO;
            break;
        case SBU_MENU_YINCHUAN:
            title = STR_ID_YINCHUAN;
            message = STR_ID_YINCHUAN_INFO;
            break;
        case SBU_MENU_SHANXI:
            title = STR_ID_SHANXI;
            message = STR_ID_SHANXI_INFO;
            break;
        case SBU_MENU_XINJIANG:
            title = STR_ID_XINJIANG;
            message = STR_ID_XINJIANG_INFO;
            break;
        case SBU_MENU_XINING:
            title = STR_ID_XINING;
            message = STR_ID_XINING_INFO;
            break;
        case SBU_MENU_GUANGDONG:
            title = STR_ID_GUANGDONG;
            message = STR_ID_GUANGDONG_INFO;
            break;
        case SBU_MENU_HAINAN:
            title = STR_ID_HAINAN;
            message = STR_ID_HAINAN_INFO;
            break;
        case SBU_MENU_TIANJING:
            title = STR_ID_TIANJING;
            message = STR_ID_TIANJING_INFO;
            break;
        case SBU_MENU_HEIBEI:
            title = STR_ID_HEIBEI;
            message = STR_ID_HEIBEI_INFO;
            break;
        case SBU_MENU_ANHUI:
            title = STR_ID_ANHUI;
            message = STR_ID_ANHUI_INFO;
            break;
        case SBU_MENU_JIANGXI:
            title = STR_ID_JIANGXI;
            message = STR_ID_JIANGXI_INFO;
            break;
        case SBU_MENU_BEIJING:
            title = STR_ID_BEIJING;
            message = STR_ID_BEIJING_INFO;
            break;
        case SBU_MENU_SHANXI2:
            title = STR_ID_SHANXI2;
            message = STR_ID_SHANXI2_INFO;
            break;
        case SBU_MENU_HEILONGJIANG:
            title = STR_ID_HEILONGJIANG;
            message = STR_ID_HEILONGJIANG_INFO;
            break;
        case SBU_MENU_LIAONING:
            title = STR_ID_LIAONING;
            message = STR_ID_LIAONING_INFO;
            break;
        case SBU_MENU_JILIN:
            title = STR_ID_JILIN;
            message = STR_ID_JILIN_INFO;
            break;
        case SBU_MENU_NEIMENGGU:
            title = STR_ID_NEIMENGGU;
            message = STR_ID_NEIMENGGU_INFO;
            break;
    }
...
mmi_ret mmi_kenuo_paradise_proc(mmi_event_struct *evt)
{
    ...
    switch (evt->evt_id)
    {
        ...
        case EVT_ID_CUI_MENU_ITEM_TAP:
            if (menu_evt->highlighted_menu_id != MAIN_MENU_KENUO_PARADISE_MENUID
                &&menu_evt->highlighted_menu_id != SBU_MENU_KENUO_BRANCH)
            {
                entry_kenuo_paradise_show(menu_evt->highlighted_menu_id);
            }
...
void entry_kenuo_paradise(void)
{
    MMI_ID menu_gid;
    ...
    menu_gid = cui_menu_create(
        ...
        MAIN_MENU_KENUO_PARADISE_MENUID,
        MMI_FALSE,
        NULL);
...
void highlight_mainmenu_kenuo_paradise()
{
    set_main_menu_softkey_handler(entry_kenuo_paradise, handle_mainmenu_right_softkey_up);
}
#endif
