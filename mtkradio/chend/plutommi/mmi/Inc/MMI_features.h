...
*****************************************************************************/
	...
	#if defined(__D36_YL_T6024D__)||defined(__D26_YL_T6024Q__)||defined(__D26_YLT_PM336__)||defined(__A8_MIGE__) ||defined(__D26_YL_T6026__)||defined(__D26_XZQ__)||defined(__F303_YST_F12__ )
		#ifdef __MMI_VIRTUAL_KEYBOARD__
		#undef __MMI_VIRTUAL_KEYBOARD__
		#endif
	#endif
#endif
...
#if 0//defined(__F303_YST_F12__)//修改触屏此宏没打开。
	...
	(defined(__MMI_CSTAR_V2__) && defined(__MMI_NORMAL_KEYPAD__) && !defined(__OP01_FWPBW__)) || (defined(__MMI_CSTAR_PHRASE_INPUT__))
...
#if !defined(__BYT_SWITCH_REMOVE_FILE_MANAGER_FUNCTIONE__)
...
#define __MMI_FACTORY_MODE__
...
#if 0//(defined(__MMI_DUAL_SIM_MASTER__) && defined(__MMI_MAINLCD_128X128__))
	...
	//#if defined(__D36_YL__)||defined(__D26_YL__)||defined(__D26_YLT__)||defined(__A8_MIGE__)||defined(__D26_XZQ__)||defined(__F303_YST_F12__)
	#if defined(__DIALING_SCREEN_NUMBER_USE_IMAGE__)
		#ifdef __MMI_TOUCH_DIAL_SCREEN__
		#undef __MMI_TOUCH_DIAL_SCREEN__
		#endif
	#endif
#endif
    ...
    (!defined(__MMI_DEL_VIBRATION_FUNCTION__))
...
#define __MMI_UI_CATEGORY_DIAL_TYPE_SEL__	DIAL_TYPE_DEFAULT
...
#if (!defined(__LOW_COST_SUPPORT_COMMON__))||defined(__L39_APS_ITALIAN_VERSION__)//YZHD 20131205
...
#if !defined(__BYT_SWITCH_REMOVE_AUDPLY_FUNCTIONE__)//YZHD 20131012 提取跟优化
...
#if (defined(__LOW_COST_SUPPORT_COMMON__) && (defined(__MMI_MAINLCD_96X64__)||defined(__MMI_MAINLCD_128X128__) || defined(__MMI_MAINLCD_128X160__) || defined(__MMI_MAINLCD_176X220__) || defined(__MMI_MAINLCD_240X320__) || defined(__MMI_MAINLCD_220X176__) || defined(__MMI_MAINLCD_160X128__)|| defined(__MMI_MAINLCD_320X240__)))
...
#if !defined(__L39_SL_200__)&&!defined(__MMI_SPANISH_DEFAULT_VALUE__)//YZHD 20130912
#if !defined(__BYT_SWITCH_REMOVE_SOUNDREC_FUNCTIONE__)//YZHD 20131203 提取去掉sound recorder function
   ...
   #if defined(__F303_YST_F12__)
      #if !defined(__PHONE_CLAMSHELL__)//songfeng 翻盖手机不需要自动键盘锁
...
#if !defined(__BYT_SWITCH_REMOVE_IMAGE_VIEWER_FUNCTIONE__)//YZHD 20131101 提取跟优化
	...
	#if !defined(__L39_SM_F9_220x176_MMI__)//@darren 20130826 三明F9项目不带相册功能
...
#if !defined(__BYT_SWITCH_REMOVE_CAMERA_FUNCTIONE__)//YZHD 20131012 提取跟优化
	...
	#if (!defined(__MMI_IMAGE_VIEWER__))&& !defined(__L39_SM_F9_220x176_MMI__)
	#error "please turn on image viewer!"
	#endif
	
	#ifndef __MMI_CAMERA__
	#if !defined(__L39_SM_F9_220x176_MMI__)
	#define __MMI_CAMERA__
	#endif
	#endif

	#if defined(__A8_MIGE_A31_60D__)
		#ifdef __MMI_CAMERA__
		#undef __MMI_CAMERA__
		#endif
	#endif	
#endif
#endif
...
#if !defined(__BYT_SWITCH_REMOVE_VDOREC_FUNCTIONE__)//YZHD 20131012 提取跟优化
#if !defined(__L39_160X128_YST__) && !defined(__L39_60m_SM_220x176_MMI__) && !defined(__L39_60m_COMMON_220x176_MMI__)&&!defined(__A76_60M_SF_110__)
	...
	(!defined(__MMI_QWERTY_KEYPAD_SUPPORT__)&& !defined(__MMI_DIALER_SLIM__)&& !defined(__DIALING_NUMBER_USE_IMAGE__)&& !defined(__DIALING_SCREEN_NUMBER_USE_IMAGE__)	)
...
#if (!defined(__32_32_SEG__) && !defined(__64_64_SEG__))||!defined(__MMI_CLOG_SLIM__)
...
#if defined(CFG_MMI_PHOTOEDITOR) && ((CFG_MMI_PHOTOEDITOR == __ON__)||(CFG_MMI_PHOTOEDITOR == __AUTO__)) && \
	(!defined(__COSMOS_MMI_PACKAGE__) && defined(__SCALADO_SUPPORT__) && (defined(__MMI_MAINLCD_176X220__) || defined(__MMI_MAINLCD_240X320__) || defined(__MMI_MAINLCD_320X240__) || defined(__MMI_MAINLCD_240X400__) || defined(__MMI_MAINLCD_320X480__)))
	#ifndef __MMI_PHOTOEDITOR__
	#define __MMI_PHOTOEDITOR__
	#endif
#endif
...
#if 0
#if ((((defined(__MMI_NORMAL_KEYPAD__)||defined(__MMI_XT9__) || (defined (__MMI_IME_V3__) && defined(__MMI_CSTAR__)) || defined(__MMI_IME_ALPHANUMERIC_VK_SUPPORT__)) && (defined(__MMI_CSTAR__) || defined(__MMI_ZI__) || defined(__MMI_T9__)))) ||  (defined(__MMI_KOMOXO__) || defined(__MMI_GUOBI__)) ) ||\
	 (defined(__MMI_KOMOXO__) || defined(__MMI_GUOBI__))
       #if !defined(__D26_ZHC_C318A__)&&!defined(__D36_60D_YLT_PT344__)
...
#if defined(__L39_APS_ITALIAN_VERSION__)
#if ((((defined(__MMI_NORMAL_KEYPAD__)||defined(__MMI_XT9__) || (defined (__MMI_IME_V3__) && defined(__MMI_CSTAR__)) || defined(__MMI_IME_ALPHANUMERIC_VK_SUPPORT__)) && (defined(__MMI_CSTAR__) || defined(__MMI_ZI__) || defined(__MMI_T9__)))) ||  (defined(__MMI_KOMOXO__) || defined(__MMI_GUOBI__)) ) ||\
	 (defined(__MMI_KOMOXO__) || defined(__MMI_GUOBI__))
           #ifndef __MMI_SMART_ALPHABETIC_INPUT_METHODS__
           #define __MMI_SMART_ALPHABETIC_INPUT_METHODS__
...
#if 0 //(defined(__MMI_IME_ENGLISH__) && defined(__MMI_CSTAR__))
	#ifndef __MMI_CSTAR_ENGLISH__
	#define __MMI_CSTAR_ENGLISH__
	#endif
#endif
#if defined(__D26_YLT_PM318__) || defined(__D36_60D_YLT_PT344__)||defined(__A76_ZKN_240x320__)
	#ifdef __MMI_CSTAR_ENGLISH__
	#undef __MMI_CSTAR_ENGLISH__
	#endif
...
/* under construction !*/
...
#if !defined(__BYT_SWITCH_REMOVE_VDOPLY_FUNCTIONE__)//YZHD 20131012 提取跟优化
	...
	#if defined(__A76_60M_SF_110__)
		#ifdef __MMI_VIDEO_PLAYER__
		#undef __MMI_VIDEO_PLAYER__
		#endif
	#endif
#endif
#endif
...
/* under construction !*/
	...
	#if defined(__A8_MIGE__)||defined(__D56_ZHC_C318D__)
		#ifdef __MMI_FM_TOUCH_PANEL_ACCURACY_TEST__
		#undef __MMI_FM_TOUCH_PANEL_ACCURACY_TEST__
		#endif
	#endif
#endif
...
#if (!defined(__MMI_MAINLCD_128X128__) && !defined(__MMI_SLIM_FILE_MANAGER__)) || defined(__SPICE_MMI_STYLE__)
...
//wangshengyuan add game application 20120629
#if defined(CFG_MMI_GAME_MENU) && ((CFG_MMI_GAME_MENU == __ON__)||(CFG_MMI_GAME_MENU == __AUTO__)) && \
	(!defined(GE_BROGENT) && !defined(GE_INTERGRAFX))
	#ifndef __MMI_GAME_MENU__
	#define __MMI_GAME_MENU__
	#endif
#endif


#if defined(CFG_MMI_GAME_CHICKEN) && ((CFG_MMI_GAME_CHICKEN == __ON__)||(CFG_MMI_GAME_CHICKEN == __AUTO__)) && \
	(defined(__MMI_GAME_MENU__) && (defined(__MMI_MAINLCD_128X128__) || defined(__MMI_MAINLCD_128X160__)))
	#ifndef __MMI_GAME_CHICKEN__
	#define __MMI_GAME_CHICKEN__
	#endif
#endif


#if defined(CFG_MMI_GAME_COLORBALLS) && ((CFG_MMI_GAME_COLORBALLS == __ON__)||(CFG_MMI_GAME_COLORBALLS == __AUTO__)) && \
	(defined(__MMI_GAME_MENU__) && defined(__MMI_MAINLCD_128X128__))
	#ifndef __MMI_GAME_COLORBALLS__
	#define __MMI_GAME_COLORBALLS__
	#endif
#endif


#if defined(CFG_MMI_GAME_COPTER) && ((CFG_MMI_GAME_COPTER == __ON__)||(CFG_MMI_GAME_COPTER == __AUTO__)) && \
	(defined(__MMI_GAME_MENU__) && (defined(__MMI_MAINLCD_128X128__) || defined(__MMI_MAINLCD_128X160__) || defined(__MMI_MAINLCD_220X176__)  || defined(__MMI_MAINLCD_176X220__)))
	#ifndef __MMI_GAME_COPTER__
	#define __MMI_GAME_COPTER__
	#endif
#endif


#if defined(CFG_MMI_GAME_DANCE) && ((CFG_MMI_GAME_DANCE == __ON__)||(CFG_MMI_GAME_DANCE == __AUTO__)) && \
	(defined(__MMI_GAME_MENU__) && defined(__MMI_MAINLCD_176X220__))
	#ifndef __MMI_GAME_DANCE__
	#define __MMI_GAME_DANCE__
	#endif
#endif


#if defined(CFG_MMI_GAME_DOLL) && ((CFG_MMI_GAME_DOLL == __ON__)||(CFG_MMI_GAME_DOLL == __AUTO__)) && \
	(defined(__MMI_GAME_MENU__) && defined(__MMI_MAINLCD_128X128__))
	#ifndef __MMI_GAME_DOLL__
	#define __MMI_GAME_DOLL__
	#endif
#endif


#if defined(CFG_MMI_GAME_F1RACE) && ((CFG_MMI_GAME_F1RACE == __ON__)||(CFG_MMI_GAME_F1RACE == __AUTO__)) && \
	(defined(__MMI_GAME_MENU__) && defined(__MMI_MAINLCD_128X128__))
	#ifndef __MMI_GAME_F1RACE__
	#define __MMI_GAME_F1RACE__
	#endif
#endif


#if defined(CFG_MMI_GAME_FRUIT) && ((CFG_MMI_GAME_FRUIT == __ON__)||(CFG_MMI_GAME_FRUIT == __AUTO__)) && \
	(defined(__MMI_GAME_MENU__) && defined(__MMI_MAINLCD_176X220__) && !defined(__MMI_TOUCH_SCREEN__))
	#ifndef __MMI_GAME_FRUIT__
	#define __MMI_GAME_FRUIT__
	#endif
#endif


#if defined(CFG_MMI_GAME_HANOI) && ((CFG_MMI_GAME_HANOI == __ON__)||(CFG_MMI_GAME_HANOI == __AUTO__)) && \
	(defined(__MMI_GAME_MENU__) && defined(__MMI_MAINLCD_128X128__))
	#ifndef __MMI_GAME_HANOI__
	#define __MMI_GAME_HANOI__
	#endif
#endif


#if defined(CFG_MMI_GAME_JET) && ((CFG_MMI_GAME_JET == __ON__)||(CFG_MMI_GAME_JET == __AUTO__)) && \
	(defined(__MMI_GAME_MENU__) && (defined(__MMI_MAINLCD_128X128__) || defined(__MMI_MAINLCD_128X160__) || defined(__MMI_MAINLCD_176X220__)))
	#ifndef __MMI_GAME_JET__
	#define __MMI_GAME_JET__
	#endif
#endif


#if defined(CFG_MMI_GAME_MAGICSUSHI) && ((CFG_MMI_GAME_MAGICSUSHI == __ON__)||(CFG_MMI_GAME_MAGICSUSHI == __AUTO__)) && \
	(defined(__MMI_GAME_MENU__) && (defined(__MMI_MAINLCD_240X320__) ||defined(__MMI_MAINLCD_272X480__)|| defined(__MMI_MAINLCD_320X240__) || defined(__MMI_MAINLCD_240X400__) || defined(__MMI_MAINLCD_320X480__))  && !defined(__MMI_FTE_SUPPORT__))
	#ifndef __MMI_GAME_MAGICSUSHI__
	#define __MMI_GAME_MAGICSUSHI__
	#endif
#endif


#if defined(CFG_MMI_GAME_MAJUNG) && ((CFG_MMI_GAME_MAJUNG == __ON__)||(CFG_MMI_GAME_MAJUNG == __AUTO__)) && \
	(defined(__MMI_GAME_MENU__) && (defined(__MMI_MAINLCD_176X220__) || defined(__MMI_MAINLCD_240X320__)||defined(__MMI_MAINLCD_272X480__) || defined(__MMI_MAINLCD_320X240__) || defined(__MMI_MAINLCD_240X400__)  || defined(__MMI_MAINLCD_320X480__))  && !defined(__MMI_FTE_SUPPORT__))
	#ifndef __MMI_GAME_MAJUNG__
	#define __MMI_GAME_MAJUNG__
	#endif
#endif


#if defined(CFG_MMI_GAME_MONKEY) && ((CFG_MMI_GAME_MONKEY == __ON__)||(CFG_MMI_GAME_MONKEY == __AUTO__)) && \
	(defined(__MMI_GAME_MENU__) && (defined(__MMI_MAINLCD_128X128__) || defined(__MMI_MAINLCD_128X160__) || defined(__MMI_MAINLCD_176X220__)))
	#ifndef __MMI_GAME_MONKEY__
	#define __MMI_GAME_MONKEY__
	#endif
#endif


#if defined(CFG_MMI_GAME_PANDA) && ((CFG_MMI_GAME_PANDA == __ON__)||(CFG_MMI_GAME_PANDA == __AUTO__)) && \
	(defined(__MMI_GAME_MENU__) && (defined(__MMI_MAINLCD_128X128__) || defined(__MMI_MAINLCD_128X160__) || defined(__MMI_MAINLCD_176X220__)))
	#ifndef __MMI_GAME_PANDA__
	#define __MMI_GAME_PANDA__
	#endif
#endif


#if defined(CFG_MMI_GAME_PUZZLE) && ((CFG_MMI_GAME_PUZZLE == __ON__)||(CFG_MMI_GAME_PUZZLE == __AUTO__)) && \
	(defined(__MMI_GAME_MENU__) && (defined(__MMI_MAINLCD_128X128__) || defined(__MMI_MAINLCD_128X160__) || defined(__MMI_MAINLCD_176X220__) || defined(__MMI_MAINLCD_220X176__) || defined(__MMI_MAINLCD_240X320__)||defined(__MMI_MAINLCD_272X480__) || defined(__MMI_MAINLCD_240X400__) || defined(__MMI_MAINLCD_320X240__) || defined(__MMI_MAINLCD_320X480__)))
	#ifndef __MMI_GAME_PUZZLE__
	#define __MMI_GAME_PUZZLE__
	#endif
#endif


#if defined(CFG_MMI_GAME_RICHES) && ((CFG_MMI_GAME_RICHES == __ON__)||(CFG_MMI_GAME_RICHES == __AUTO__)) && \
	(defined(__MMI_GAME_MENU__) && defined(__MMI_MAINLCD_128X128__))
	#ifndef __MMI_GAME_RICHES__
	#define __MMI_GAME_RICHES__
	#endif
#endif


#if defined(CFG_MMI_GAME_ROBOT) && ((CFG_MMI_GAME_ROBOT == __ON__)||(CFG_MMI_GAME_ROBOT == __AUTO__)) && \
	(defined(__MMI_GAME_MENU__) && (defined(__MMI_MAINLCD_128X160__) || defined(__MMI_MAINLCD_176X220__)))
	#ifndef __MMI_GAME_ROBOT__
	#define __MMI_GAME_ROBOT__
	#endif
#endif


#if defined(CFG_MMI_GAME_SMASH) && ((CFG_MMI_GAME_SMASH == __ON__)||(CFG_MMI_GAME_SMASH == __AUTO__)) && \
	(defined(__MMI_GAME_MENU__) && defined(__MMI_MAINLCD_128X128__))
	#ifndef __MMI_GAME_SMASH__
	#define __MMI_GAME_SMASH__
	#endif
#endif


#if defined(CFG_MMI_GAME_SNAKE) && ((CFG_MMI_GAME_SNAKE == __ON__)||(CFG_MMI_GAME_SNAKE == __AUTO__)) && \
	(defined(__MMI_GAME_MENU__) && defined(__MMI_MAINLCD_128X128__))
	#ifndef __MMI_GAME_SNAKE__
	#define __MMI_GAME_SNAKE__
	#endif
#endif


#if defined(CFG_MMI_GAME_SUBMARINE) && ((CFG_MMI_GAME_SUBMARINE == __ON__)||(CFG_MMI_GAME_SUBMARINE == __AUTO__)) && \
	(defined(__MMI_GAME_MENU__) && (defined(__MMI_MAINLCD_128X128__) || defined(__MMI_MAINLCD_128X160__) || defined(__MMI_MAINLCD_176X220__)))
	#ifndef __MMI_GAME_SUBMARINE__
	#define __MMI_GAME_SUBMARINE__
	#endif
#endif


#if defined(CFG_MMI_GAME_UFO) && ((CFG_MMI_GAME_UFO == __ON__)||(CFG_MMI_GAME_UFO == __AUTO__)) && \
	(defined(__MMI_GAME_MENU__) && (defined(__MMI_MAINLCD_128X128__) || defined(__MMI_MAINLCD_128X160__) || defined(__MMI_MAINLCD_176X220__)))
	#ifndef __MMI_GAME_UFO__
	#define __MMI_GAME_UFO__
	#endif
#endif


#if defined(CFG_MMI_GAME_VSMJ) && ((CFG_MMI_GAME_VSMJ == __ON__)||(CFG_MMI_GAME_VSMJ == __AUTO__)) && \
	(defined(__MMI_GAME_MENU__) && (defined(__MMI_MAINLCD_240X320__)||defined(__MMI_MAINLCD_272X480__) || defined(__MMI_MAINLCD_240X400__) || defined(__MMI_MAINLCD_320X240__) || defined(__MMI_MAINLCD_320X480__))  && !defined(__MMI_FTE_SUPPORT__))
	#ifndef __MMI_GAME_VSMJ__
	#define __MMI_GAME_VSMJ__
	#endif
#endif

#if defined(CFG_MMI_FULL_SCREEN_EDITOR) && ((CFG_MMI_FULL_SCREEN_EDITOR == __ON__)||(CFG_MMI_FULL_SCREEN_EDITOR == __AUTO__)) && \
	(!defined(__MMI_TOUCH_SCREEN__))
	#ifndef __MMI_FULL_SCREEN_EDITOR__
	#define __MMI_FULL_SCREEN_EDITOR__
	#endif
#endif
...
#if (defined(__MMI_GAME_CHICKEN__) && defined(__MMI_MAINLCD_128X128__))
	#ifndef __MMI_GAME_CHICKEN_128x128__
	#define __MMI_GAME_CHICKEN_128x128__
	#endif
#endif


#if (defined(__MMI_GAME_CHICKEN__) && defined(__MMI_MAINLCD_128X160__))
	#ifndef __MMI_GAME_CHICKEN_128x160__
	#define __MMI_GAME_CHICKEN_128x160__
	#endif
#endif


#if (defined(__MMI_GAME_COPTER__) && defined(__MMI_MAINLCD_128X128__))
	#ifndef __MMI_GAME_COPTER_128x128__
	#define __MMI_GAME_COPTER_128x128__
	#endif
#endif


#if (defined(__MMI_GAME_COPTER__) && defined(__MMI_MAINLCD_128X160__))
	#ifndef __MMI_GAME_COPTER_128x160__
	#define __MMI_GAME_COPTER_128x160__
	#endif
#endif


#if (defined(__MMI_GAME_COPTER__) && defined(__MMI_MAINLCD_176X220__))
	#ifndef __MMI_GAME_COPTER_176x220__
	#define __MMI_GAME_COPTER_176x220__
	#endif
#endif

#if (defined(__MMI_GAME_COPTER__) && defined(__MMI_MAINLCD_220X176__))
	#ifndef __MMI_GAME_COPTER_220x176__
	#define __MMI_GAME_COPTER_220x176__
	#endif
#endif

#if (defined(__MMI_GAME_DANCE__) && defined(__MMI_MAINLCD_176X220__))
	#ifndef __MMI_GAME_DANCE_176x220__
	#define __MMI_GAME_DANCE_176x220__
	#endif
#endif

#if (defined(__MMI_GAME_FRUIT__) && defined(__MMI_MAINLCD_176X220__))
	#ifndef __MMI_GAME_FRUIT_176x220__
	#define __MMI_GAME_FRUIT_176x220__
	#endif
#endif


#if (defined(__MMI_GAME_JET__) && defined(__MMI_MAINLCD_128X128__))
	#ifndef __MMI_GAME_JET_128x128__
	#define __MMI_GAME_JET_128x128__
	#endif
#endif


#if (defined(__MMI_GAME_JET__) && defined(__MMI_MAINLCD_128X160__))
	#ifndef __MMI_GAME_JET_128x160__
	#define __MMI_GAME_JET_128x160__
	#endif
#endif


#if (defined(__MMI_GAME_JET__) && defined(__MMI_MAINLCD_176X220__))
	#ifndef __MMI_GAME_JET_176x220__
	#define __MMI_GAME_JET_176x220__
	#endif
#endif


#if (defined(__MMI_GAME_MAGICSUSHI__) && defined(__MMI_MAINLCD_272X480__))
	#ifndef __MMI_GAME_MAGICSUSHI_272x480__
	#define __MMI_GAME_MAGICSUSHI_272x480__
	#endif
#endif


#if (defined(__MMI_GAME_MAGICSUSHI__) && defined(__MMI_MAINLCD_240X320__))
	#ifndef __MMI_GAME_MAGICSUSHI_240x320__
	#define __MMI_GAME_MAGICSUSHI_240x320__
	#endif
#endif


#if (defined(__MMI_GAME_MAGICSUSHI__) && defined(__MMI_MAINLCD_240X400__))
	#ifndef __MMI_GAME_MAGICSUSHI_240x400__
	#define __MMI_GAME_MAGICSUSHI_240x400__
	#endif
#endif


#if (defined(__MMI_GAME_MAGICSUSHI__) && defined(__MMI_MAINLCD_320X240__))
	#ifndef __MMI_GAME_MAGICSUSHI_320x240__
	#define __MMI_GAME_MAGICSUSHI_320x240__
	#endif
#endif


#if (defined(__MMI_GAME_MAGICSUSHI__) && defined(__MMI_MAINLCD_320X480__))
	#ifndef __MMI_GAME_MAGICSUSHI_320x480__
	#define __MMI_GAME_MAGICSUSHI_320x480__
	#endif
#endif


#if (defined(__MMI_GAME_MAJUNG__) && defined(__MMI_MAINLCD_176X220__))
	#ifndef __MMI_GAME_MAJUNG_176x220__
	#define __MMI_GAME_MAJUNG_176x220__
	#endif
#endif


#if (defined(__MMI_GAME_MAJUNG__) && defined(__MMI_MAINLCD_240X320__))
	#ifndef __MMI_GAME_MAJUNG_240x320__
	#define __MMI_GAME_MAJUNG_240x320__
	#endif
#endif

#if (defined(__MMI_GAME_MAJUNG__) && defined(__MMI_MAINLCD_272X480__))
	#ifndef __MMI_GAME_MAJUNG_272x480__
	#define __MMI_GAME_MAJUNG_272x480__
	#endif
#endif

#if (defined(__MMI_GAME_MAJUNG__) && defined(__MMI_MAINLCD_240X400__))
	#ifndef __MMI_GAME_MAJUNG_240x400__
	#define __MMI_GAME_MAJUNG_240x400__
	#endif
#endif


#if (defined(__MMI_GAME_MAJUNG__) && defined(__MMI_MAINLCD_320X240__))
	#ifndef __MMI_GAME_MAJUNG_320x240__
	#define __MMI_GAME_MAJUNG_320x240__
	#endif
#endif


#if (defined(__MMI_GAME_MAJUNG__) && defined(__MMI_MAINLCD_320X480__))
	#ifndef __MMI_GAME_MAJUNG_320x480__
	#define __MMI_GAME_MAJUNG_320x480__
	#endif
#endif


#if (defined(__MMI_GAME_MONKEY__) && defined(__MMI_MAINLCD_128X128__))
	#ifndef __MMI_GAME_MONKEY_128x128__
	#define __MMI_GAME_MONKEY_128x128__
	#endif
#endif


#if (defined(__MMI_GAME_MONKEY__) && defined(__MMI_MAINLCD_128X160__))
	#ifndef __MMI_GAME_MONKEY_128x160__
	#define __MMI_GAME_MONKEY_128x160__
	#endif
#endif


#if (defined(__MMI_GAME_MONKEY__) && defined(__MMI_MAINLCD_176X220__))
	#ifndef __MMI_GAME_MONKEY_176x220__
	#define __MMI_GAME_MONKEY_176x220__
	#endif
#endif


#if defined(CFG_MMI_GAME_MULTI_LANGUAGE_SUPPORT) && ((CFG_MMI_GAME_MULTI_LANGUAGE_SUPPORT == __ON__)||(CFG_MMI_GAME_MULTI_LANGUAGE_SUPPORT == __AUTO__)) && \
...
#if (defined(__MMI_GAME_PANDA__) && defined(__MMI_MAINLCD_128X128__))
	#ifndef __MMI_GAME_PANDA_128x128__
	#define __MMI_GAME_PANDA_128x128__
	#endif
#endif


#if (defined(__MMI_GAME_PANDA__) && defined(__MMI_MAINLCD_128X160__))
	#ifndef __MMI_GAME_PANDA_128x160__
	#define __MMI_GAME_PANDA_128x160__
	#endif
#endif


#if (defined(__MMI_GAME_PANDA__) && defined(__MMI_MAINLCD_176X220__))
	#ifndef __MMI_GAME_PANDA_176x220__
	#define __MMI_GAME_PANDA_176x220__
	#endif
#endif


#if (defined(__MMI_GAME_PUZZLE__) && defined(__MMI_MAINLCD_128X128__))
	#ifndef __MMI_GAME_PUZZLE_128x128__
	#define __MMI_GAME_PUZZLE_128x128__
	#endif
#endif


#if (defined(__MMI_GAME_PUZZLE__) && defined(__MMI_MAINLCD_128X160__))
	#ifndef __MMI_GAME_PUZZLE_128x160__
	#define __MMI_GAME_PUZZLE_128x160__
	#endif
#endif


#if (defined(__MMI_GAME_PUZZLE__) && defined(__MMI_MAINLCD_176X220__))
	#ifndef __MMI_GAME_PUZZLE_176x220__
	#define __MMI_GAME_PUZZLE_176x220__
	#endif
#endif

#if (defined(__MMI_GAME_PUZZLE__) && defined(__MMI_MAINLCD_220X176__))
	#ifndef __MMI_GAME_PUZZLE_220x176__
	#define __MMI_GAME_PUZZLE_220x176__
	#endif
#endif

#if (defined(__MMI_GAME_PUZZLE__) && defined(__MMI_MAINLCD_240X320__))
	#ifndef __MMI_GAME_PUZZLE_240x320__
	#define __MMI_GAME_PUZZLE_240x320__
	#endif
#endif


#if (defined(__MMI_GAME_PUZZLE__) && defined(__MMI_MAINLCD_272X480__))
	#ifndef __MMI_GAME_PUZZLE_272x480__
	#define __MMI_GAME_PUZZLE_272x480__
	#endif
#endif


#if (defined(__MMI_GAME_PUZZLE__) && defined(__MMI_MAINLCD_240X400__))
	#ifndef __MMI_GAME_PUZZLE_240x400__
	#define __MMI_GAME_PUZZLE_240x400__
	#endif
#endif


#if (defined(__MMI_GAME_PUZZLE__) && defined(__MMI_MAINLCD_320X240__))
	#ifndef __MMI_GAME_PUZZLE_320x240__
	#define __MMI_GAME_PUZZLE_320x240__
	#endif
#endif


#if (defined(__MMI_GAME_PUZZLE__) && defined(__MMI_MAINLCD_320X480__))
	#ifndef __MMI_GAME_PUZZLE_320x480__
	#define __MMI_GAME_PUZZLE_320x480__
	#endif
#endif


#if (defined(__MMI_GAME_ROBOT__) && defined(__MMI_MAINLCD_128X160__))
	#ifndef __MMI_GAME_ROBOT_128x160__
	#define __MMI_GAME_ROBOT_128x160__
	#endif
#endif


#if (defined(__MMI_GAME_ROBOT__) && defined(__MMI_MAINLCD_176X220__))
	#ifndef __MMI_GAME_ROBOT_176x220__
	#define __MMI_GAME_ROBOT_176x220__
	#endif
#endif


#if (defined(__MMI_GAME_SUBMARINE__) && defined(__MMI_MAINLCD_128X128__))
	#ifndef __MMI_GAME_SUBMARINE_128x128__
	#define __MMI_GAME_SUBMARINE_128x128__
	#endif
#endif


#if (defined(__MMI_GAME_SUBMARINE__) && defined(__MMI_MAINLCD_128X160__))
	#ifndef __MMI_GAME_SUBMARINE_128x160__
	#define __MMI_GAME_SUBMARINE_128x160__
	#endif
#endif


#if (defined(__MMI_GAME_SUBMARINE__) && defined(__MMI_MAINLCD_176X220__))
	#ifndef __MMI_GAME_SUBMARINE_176x220__
	#define __MMI_GAME_SUBMARINE_176x220__
	#endif
#endif


#if (defined(__MMI_GAME_UFO__) && defined(__MMI_MAINLCD_128X128__))
	#ifndef __MMI_GAME_UFO_128x128__
	#define __MMI_GAME_UFO_128x128__
	#endif
#endif


#if (defined(__MMI_GAME_UFO__) && defined(__MMI_MAINLCD_128X160__))
	#ifndef __MMI_GAME_UFO_128x160__
	#define __MMI_GAME_UFO_128x160__
	#endif
#endif


#if (defined(__MMI_GAME_UFO__) && defined(__MMI_MAINLCD_176X220__))
	#ifndef __MMI_GAME_UFO_176x220__
	#define __MMI_GAME_UFO_176x220__
	#endif
#endif


#if (defined(__MMI_GAME_VSMJ__) && defined(__MMI_MAINLCD_240X320__))
	#ifndef __MMI_GAME_VSMJ_240x320__
	#define __MMI_GAME_VSMJ_240x320__
	#endif
#endif


#if (defined(__MMI_GAME_VSMJ__)&& defined(__MMI_MAINLCD_272X480__))
	#ifndef __MMI_GAME_VSMJ_272x480__
	#define __MMI_GAME_VSMJ_272x480__
	#endif
#endif


#if (defined(__MMI_GAME_VSMJ__) && defined(__MMI_MAINLCD_240X400__))
	#ifndef __MMI_GAME_VSMJ_240x400__
	#define __MMI_GAME_VSMJ_240x400__
	#endif
#endif


#if (defined(__MMI_GAME_VSMJ__) && defined(__MMI_MAINLCD_320X240__))
	#ifndef __MMI_GAME_VSMJ_320x240__
	#define __MMI_GAME_VSMJ_320x240__
	#endif
#endif


#if (defined(__MMI_GAME_VSMJ__) && defined(__MMI_MAINLCD_320X480__))
	#ifndef __MMI_GAME_VSMJ_320x480__
	#define __MMI_GAME_VSMJ_320x480__
	#endif
#endif
...
#if (defined(__MMI_MULTITAP__) && defined(__MMI_LANG_THAI__)&& (defined(__MMI_IME_V3__) || defined(__MMI_T9_MULTITAP__) || defined(__MMI_CSTAR_MULTITAP__)||defined(__G96_60M_SF_WAIWEN__)))
...
#if defined(__F303_YST_F12__)//songfeng 使有触屏时支持page主菜单
#if defined(CFG_MMI_MAINMENU_PAGE_SUPPORT) && ((CFG_MMI_MAINMENU_PAGE_SUPPORT == __ON__)||(CFG_MMI_MAINMENU_PAGE_SUPPORT == __AUTO__))
	#ifndef __MMI_MAINMENU_PAGE_SUPPORT__
	#define __MMI_MAINMENU_PAGE_SUPPORT__
	#endif
...
#if defined(CFG_MMI_UNIT_CONVERTER) && ((CFG_MMI_UNIT_CONVERTER == __ON__)||(CFG_MMI_UNIT_CONVERTER == __AUTO__))
...
#if defined(CFG_MMI_PHB_CALLER_GROUP) && ((CFG_MMI_PHB_CALLER_GROUP == __ON__)||(CFG_MMI_PHB_CALLER_GROUP == __AUTO__)) /* wilson.zheng 20130328 开启电话群组 */
...
#if defined(CFG_MMI_ALM_FM_RADIO_SUPPORT) && ((CFG_MMI_ALM_FM_RADIO_SUPPORT == __ON__)||(CFG_MMI_ALM_FM_RADIO_SUPPORT == __AUTO__))
	#ifndef __MMI_ALM_FM_RADIO_SUPPORT__
	#define __MMI_ALM_FM_RADIO_SUPPORT__
	#endif
#endif
...
//add by YZHD 20130710 one key speep dial
#if defined(CFG_MMI_PHB_ONE_KEY_SPEED_DIAL) && ((CFG_MMI_PHB_ONE_KEY_SPEED_DIAL == __ON__)||(CFG_MMI_PHB_ONE_KEY_SPEED_DIAL == __AUTO__))&&defined(__MMI_PHB_SPEED_DIAL__)
	#ifndef __MMI_PHB_ONE_KEY_SPEED_DIAL__
	#define __MMI_PHB_ONE_KEY_SPEED_DIAL__
	#endif
#endif
...
#if (defined(__MMI_FWUI_SLIM__))&&!defined(__L39_60D_SJTY_240X320_GPRS__)//modify by YZHD 20130628
...
#if (defined(__MMI_FWUI_SLIM__)) && !defined(__SPICE_MMI_STYLE__)
...
#if defined(__MMI_ANIMATED_WALLPAPERS__) //YZHD 20131104 待机墙纸支持动画
	#ifndef __MMI_RES_TYPE_WALLPAPER__
	#define __MMI_RES_TYPE_WALLPAPER__	"GIF"
	#endif
#else
#if (((!defined(__MMI_FWUI_SLIM__)) && ((defined(__MMI_RES_TYPE_WALLPAPER_SEL__) && (__MMI_RES_TYPE_WALLPAPER_SEL__ == __RES_TYPE_BMP__)) || (defined(__MMI_VUI_LAUNCHER_KEY__)) || ((defined(__CPU_ARM7EJ_S__) && !defined(__COSMOS_MMI_PACKAGE__) && (defined(__MMI_MAINLCD_240X400__) ))))))
	#ifndef __MMI_RES_TYPE_WALLPAPER__
   ...
   #if defined(__F303_YST_F12__)//songfeng 翻盖手机不需手动键盘锁
...
#if (defined(__MMI_SOUND_RECORDER__) && (defined(__MMI_FTE_SUPPORT__) || !(defined(__MMI_FWUI_SLIM__) || defined(__32_32_SEG__) || defined(__16_32_SEG__) || defined(__24_32_SEG__) || defined(__MMI_MAINLCD_96X64__) || defined(__MMI_MAINLCD_128X128__) || defined(__MMI_MAINLCD_128X160__))))
	#ifndef __MMI_SNDREC_SKIN__
	#define __MMI_SNDREC_SKIN__
	#endif
#endif

#ifndef __AUTO_RECORD_IN_CALL__
...
/* under construction !*/
...
#if 0 //defined(CFG_MMI_UCM_RSK_SUPPRESS_RING) && ((CFG_MMI_UCM_RSK_SUPPRESS_RING == __ON__)||(CFG_MMI_UCM_RSK_SUPPRESS_RING == __AUTO__)) && \
	...
	(!defined(__MMI_TOUCH_SCREEN__) && (!defined(__MMI_MAINLCD_96X64__)&&!defined(__MMI_MAINLCD_128X128__) && !defined(__MMI_MAINLCD_128X160__)))
...
#if defined(CFG_MMI_WGUI_DISABLE_CSK) && ((CFG_MMI_WGUI_DISABLE_CSK == __ON__)||(CFG_MMI_WGUI_DISABLE_CSK == __AUTO__)) 
...
/* under construction !*/
	#endif
#endif
#if defined(CFG_MMI_ZI_SM_CHINESE) && ((CFG_MMI_ZI_SM_CHINESE == __ON__)||(CFG_MMI_ZI_SM_CHINESE == __AUTO__)) && \
	(defined(__MMI_ZI__) && defined(__MMI_LANG_SM_CHINESE__))
	#ifndef __MMI_ZI_SM_CHINESE__
	#define __MMI_ZI_SM_CHINESE__
	#endif
#endif


#if defined(CFG_MMI_ZI_TR_CHINESE) && ((CFG_MMI_ZI_TR_CHINESE == __ON__)||(CFG_MMI_ZI_TR_CHINESE == __AUTO__)) && \
	(defined(__MMI_ZI__) && defined(__MMI_LANG_TR_CHINESE__))
	#ifndef __MMI_ZI_TR_CHINESE__
	#define __MMI_ZI_TR_CHINESE__
	#endif
#endif

#if defined(CFG_MMI_ZI_AFRIKAANS) && ((CFG_MMI_ZI_AFRIKAANS == __ON__)||(CFG_MMI_ZI_AFRIKAANS == __AUTO__)) && \
	(defined(__MMI_ZI_V7__) && defined(__MMI_SMART_ALPHABETIC_INPUT_METHODS__)&& defined(__MMI_LANG_AFRIKAANS__))
	#ifndef __MMI_ZI_AFRIKAANS__
	#define __MMI_ZI_AFRIKAANS__
	#endif
#endif


#if defined(CFG_MMI_ZI_ARABIC) && ((CFG_MMI_ZI_ARABIC == __ON__)||(CFG_MMI_ZI_ARABIC == __AUTO__)) && \
	(defined(__MMI_ZI__) && defined(__MMI_SMART_ALPHABETIC_INPUT_METHODS__)&& defined(__MMI_LANG_ARABIC__))
	#ifndef __MMI_ZI_ARABIC__
	#define __MMI_ZI_ARABIC__
	#endif
#endif


#if defined(CFG_MMI_ZI_BENGALI) && ((CFG_MMI_ZI_BENGALI == __ON__)||(CFG_MMI_ZI_BENGALI == __AUTO__)) && \
	(defined(__MMI_ZI__) && defined(__MMI_SMART_ALPHABETIC_INPUT_METHODS__)&& defined(__MMI_LANG_BENGALI__) && defined(__MMI_ZI_V7__))
	#ifndef __MMI_ZI_BENGALI__
	#define __MMI_ZI_BENGALI__
	#endif
#endif


#if defined(CFG_MMI_ZI_BULGARIAN) && ((CFG_MMI_ZI_BULGARIAN == __ON__)||(CFG_MMI_ZI_BULGARIAN == __AUTO__)) && \
	(defined(__MMI_SMART_ALPHABETIC_INPUT_METHODS__)&& defined(__MMI_LANG_BULGARIAN__)&& defined(__MMI_ZI_V7__))
	#ifndef __MMI_ZI_BULGARIAN__
	#define __MMI_ZI_BULGARIAN__
	#endif
#endif


#if defined(CFG_MMI_ZI_CA_FRENCH) && ((CFG_MMI_ZI_CA_FRENCH == __ON__)||(CFG_MMI_ZI_CA_FRENCH == __AUTO__)) && \
	(defined(__MMI_ZI__) && defined(__MMI_SMART_ALPHABETIC_INPUT_METHODS__) && defined(__MMI_LANG_CA_FRENCH__))
	#ifndef __MMI_ZI_CA_FRENCH__
	#define __MMI_ZI_CA_FRENCH__
	#endif
#endif


#if defined(CFG_MMI_ZI_CHINESE_PHRASE_LEVEL_INPUTS) && ((CFG_MMI_ZI_CHINESE_PHRASE_LEVEL_INPUTS == __ON__)||(CFG_MMI_ZI_CHINESE_PHRASE_LEVEL_INPUTS == __AUTO__)) && \
	(defined(__MMI_ZI_SM_CHINESE__) || defined(__MMI_ZI_TR_CHINESE__))
	#ifndef __MMI_ZI_CHINESE_PHRASE_LEVEL_INPUTS__
	#define __MMI_ZI_CHINESE_PHRASE_LEVEL_INPUTS__
	#endif
#endif


#if defined(CFG_MMI_ZI_CROATIAN) && ((CFG_MMI_ZI_CROATIAN == __ON__)||(CFG_MMI_ZI_CROATIAN == __AUTO__)) && \
	(defined(__MMI_ZI__) && defined(__MMI_SMART_ALPHABETIC_INPUT_METHODS__)&& defined(__MMI_LANG_CROATIAN__))
	#ifndef __MMI_ZI_CROATIAN__
	#define __MMI_ZI_CROATIAN__
	#endif
#endif


#if defined(CFG_MMI_ZI_CZECH) && ((CFG_MMI_ZI_CZECH == __ON__)||(CFG_MMI_ZI_CZECH == __AUTO__)) && \
	(defined(__MMI_ZI__) && defined(__MMI_SMART_ALPHABETIC_INPUT_METHODS__)&& defined(__MMI_LANG_CZECH__))
	#ifndef __MMI_ZI_CZECH__
	#define __MMI_ZI_CZECH__
	#endif
#endif


#if defined(CFG_MMI_ZI_DANISH) && ((CFG_MMI_ZI_DANISH == __ON__)||(CFG_MMI_ZI_DANISH == __AUTO__)) && \
	(defined(__MMI_ZI__) && defined(__MMI_SMART_ALPHABETIC_INPUT_METHODS__)&& defined(__MMI_LANG_DANISH__))
	#ifndef __MMI_ZI_DANISH__
	#define __MMI_ZI_DANISH__
	#endif
#endif


#if defined(CFG_MMI_ZI_DUTCH) && ((CFG_MMI_ZI_DUTCH == __ON__)||(CFG_MMI_ZI_DUTCH == __AUTO__)) && \
	(defined(__MMI_ZI__) && defined(__MMI_SMART_ALPHABETIC_INPUT_METHODS__)&& defined(__MMI_LANG_DUTCH__))
	#ifndef __MMI_ZI_DUTCH__
	#define __MMI_ZI_DUTCH__
	#endif
#endif


#if defined(CFG_MMI_ZI_ESTONIAN) && ((CFG_MMI_ZI_ESTONIAN == __ON__)||(CFG_MMI_ZI_ESTONIAN == __AUTO__)) && \
	(defined(__MMI_ZI_V7__) && defined(__MMI_SMART_ALPHABETIC_INPUT_METHODS__)&& defined(__MMI_LANG_ESTONIAN__))
	#ifndef __MMI_ZI_ESTONIAN__
	#define __MMI_ZI_ESTONIAN__
	#endif
#endif


#if defined(CFG_MMI_ZI_EU_FRENCH) && ((CFG_MMI_ZI_EU_FRENCH == __ON__)||(CFG_MMI_ZI_EU_FRENCH == __AUTO__)) && \
	(defined(__MMI_ZI__) && defined(__MMI_SMART_ALPHABETIC_INPUT_METHODS__)&& defined(__MMI_LANG_FRENCH__))
	#ifndef __MMI_ZI_EU_FRENCH__
	#define __MMI_ZI_EU_FRENCH__
	#endif
#endif


#if defined(CFG_MMI_ZI_EU_PORTUGUESE) && ((CFG_MMI_ZI_EU_PORTUGUESE == __ON__)||(CFG_MMI_ZI_EU_PORTUGUESE == __AUTO__)) && \
	(defined(__MMI_ZI__) && defined(__MMI_SMART_ALPHABETIC_INPUT_METHODS__)  && defined(__MMI_LANG_PORTUGUESE__))
	#ifndef __MMI_ZI_EU_PORTUGUESE__
	#define __MMI_ZI_EU_PORTUGUESE__
	#endif
#endif


#if defined(CFG_MMI_ZI_EU_SPANISH) && ((CFG_MMI_ZI_EU_SPANISH == __ON__)||(CFG_MMI_ZI_EU_SPANISH == __AUTO__)) && \
	(defined(__MMI_ZI__) && defined(__MMI_SMART_ALPHABETIC_INPUT_METHODS__) && defined(__MMI_LANG_SPANISH__))
	#ifndef __MMI_ZI_EU_SPANISH__
	#define __MMI_ZI_EU_SPANISH__
	#endif
#endif


#if defined(CFG_MMI_ZI_FINNISH) && ((CFG_MMI_ZI_FINNISH == __ON__)||(CFG_MMI_ZI_FINNISH == __AUTO__)) && \
	(defined(__MMI_ZI__) && defined(__MMI_SMART_ALPHABETIC_INPUT_METHODS__)&& defined(__MMI_LANG_FINNISH__))
	#ifndef __MMI_ZI_FINNISH__
	#define __MMI_ZI_FINNISH__
	#endif
#endif


#if defined(CFG_MMI_ZI_GERMAN) && ((CFG_MMI_ZI_GERMAN == __ON__)||(CFG_MMI_ZI_GERMAN == __AUTO__)) && \
	(defined(__MMI_ZI__) && defined(__MMI_SMART_ALPHABETIC_INPUT_METHODS__)&& defined(__MMI_LANG_GERMAN__))
	#ifndef __MMI_ZI_GERMAN__
	#define __MMI_ZI_GERMAN__
	#endif
#endif


#if defined(CFG_MMI_ZI_GREEK) && ((CFG_MMI_ZI_GREEK == __ON__)||(CFG_MMI_ZI_GREEK == __AUTO__)) && \
	(defined(__MMI_ZI__) && defined(__MMI_SMART_ALPHABETIC_INPUT_METHODS__)&& defined(__MMI_LANG_GREEK__))
	#ifndef __MMI_ZI_GREEK__
	#define __MMI_ZI_GREEK__
	#endif
#endif


#if defined(CFG_MMI_ZI_GUJARATI) && ((CFG_MMI_ZI_GUJARATI == __ON__)||(CFG_MMI_ZI_GUJARATI == __AUTO__)) && \
	(defined(__MMI_ZI__) && defined(__MMI_SMART_ALPHABETIC_INPUT_METHODS__)&& defined(__MMI_LANG_GUJARATI__))
	#ifndef __MMI_ZI_GUJARATI__
	#define __MMI_ZI_GUJARATI__
	#endif
#endif


#if defined(CFG_MMI_ZI_HEBREW) && ((CFG_MMI_ZI_HEBREW == __ON__)||(CFG_MMI_ZI_HEBREW == __AUTO__)) && \
	(defined(__MMI_ZI__) && defined(__MMI_SMART_ALPHABETIC_INPUT_METHODS__)&& defined(__MMI_LANG_HEBREW__))
	#ifndef __MMI_ZI_HEBREW__
	#define __MMI_ZI_HEBREW__
	#endif
#endif


#if defined(CFG_MMI_ZI_HINDI) && ((CFG_MMI_ZI_HINDI == __ON__)||(CFG_MMI_ZI_HINDI == __AUTO__)) && \
	(defined(__MMI_ZI__) && defined(__MMI_SMART_ALPHABETIC_INPUT_METHODS__)&& defined(__MMI_LANG_HINDI__))
	#ifndef __MMI_ZI_HINDI__
	#define __MMI_ZI_HINDI__
	#endif
#endif


#if defined(CFG_MMI_ZI_HK_CHINESE) && ((CFG_MMI_ZI_HK_CHINESE == __ON__)||(CFG_MMI_ZI_HK_CHINESE == __AUTO__)) && \
	(defined(__MMI_ZI__) && defined(__MMI_LANG_HK_CHINESE__))
	#ifndef __MMI_ZI_HK_CHINESE__
	#define __MMI_ZI_HK_CHINESE__
	#endif
#endif


#if defined(CFG_MMI_ZI_HUNGARIAN) && ((CFG_MMI_ZI_HUNGARIAN == __ON__)||(CFG_MMI_ZI_HUNGARIAN == __AUTO__)) && \
	(defined(__MMI_ZI__) && defined(__MMI_SMART_ALPHABETIC_INPUT_METHODS__)&& defined(__MMI_LANG_HUNGARIAN__))
	#ifndef __MMI_ZI_HUNGARIAN__
	#define __MMI_ZI_HUNGARIAN__
	#endif
#endif


#if defined(CFG_MMI_ZI_ICELANDIC) && ((CFG_MMI_ZI_ICELANDIC == __ON__)||(CFG_MMI_ZI_ICELANDIC == __AUTO__)) && \
	(defined(__MMI_ZI__) && defined(__MMI_SMART_ALPHABETIC_INPUT_METHODS__) && defined(__MMI_LANG_ICELANDIC__))
	#ifndef __MMI_ZI_ICELANDIC__
	#define __MMI_ZI_ICELANDIC__
	#endif
#endif


#if defined(CFG_MMI_ZI_INDONESIAN) && ((CFG_MMI_ZI_INDONESIAN == __ON__)||(CFG_MMI_ZI_INDONESIAN == __AUTO__)) && \
	(defined(__MMI_ZI__) && defined(__MMI_SMART_ALPHABETIC_INPUT_METHODS__)&& defined(__MMI_LANG_INDONESIAN__))
	#ifndef __MMI_ZI_INDONESIAN__
	#define __MMI_ZI_INDONESIAN__
	#endif
#endif


#if defined(CFG_MMI_ZI_ITALIAN) && ((CFG_MMI_ZI_ITALIAN == __ON__)||(CFG_MMI_ZI_ITALIAN == __AUTO__)) && \
	(defined(__MMI_ZI__) && defined(__MMI_SMART_ALPHABETIC_INPUT_METHODS__)&& defined(__MMI_LANG_ITALIAN__))
	#ifndef __MMI_ZI_ITALIAN__
	#define __MMI_ZI_ITALIAN__
	#endif
#endif


#if defined(CFG_MMI_ZI_KANNADA) && ((CFG_MMI_ZI_KANNADA == __ON__)||(CFG_MMI_ZI_KANNADA == __AUTO__)) && \
	(defined(__MMI_ZI__) && defined(__MMI_SMART_ALPHABETIC_INPUT_METHODS__)&& defined(__MMI_LANG_KANNADA__))
	#ifndef __MMI_ZI_KANNADA__
	#define __MMI_ZI_KANNADA__
	#endif
#endif


#if defined(CFG_MMI_ZI_LATVIAN) && ((CFG_MMI_ZI_LATVIAN == __ON__)||(CFG_MMI_ZI_LATVIAN == __AUTO__)) && \
	(defined(__MMI_ZI_V7__) && defined(__MMI_SMART_ALPHABETIC_INPUT_METHODS__)&& defined(__MMI_LANG_LATVIAN__))
	#ifndef __MMI_ZI_LATVIAN__
	#define __MMI_ZI_LATVIAN__
	#endif
#endif


#if defined(CFG_MMI_ZI_LITHUANIAN) && ((CFG_MMI_ZI_LITHUANIAN == __ON__)||(CFG_MMI_ZI_LITHUANIAN == __AUTO__)) && \
	(defined(__MMI_ZI_V7__) && defined(__MMI_SMART_ALPHABETIC_INPUT_METHODS__)&& defined(__MMI_LANG_LITHUANIAN__))
	#ifndef __MMI_ZI_LITHUANIAN__
	#define __MMI_ZI_LITHUANIAN__
	#endif
#endif


#if defined(CFG_MMI_ZI_MALAY) && ((CFG_MMI_ZI_MALAY == __ON__)||(CFG_MMI_ZI_MALAY == __AUTO__)) && \
	(defined(__MMI_ZI__) && defined(__MMI_SMART_ALPHABETIC_INPUT_METHODS__)&& defined(__MMI_LANG_MALAY__))
	#ifndef __MMI_ZI_MALAY__
	#define __MMI_ZI_MALAY__
	#endif
#endif


#if defined(CFG_MMI_ZI_MALAYALAM) && ((CFG_MMI_ZI_MALAYALAM == __ON__)||(CFG_MMI_ZI_MALAYALAM == __AUTO__)) && \
	(defined(__MMI_ZI__) && defined(__MMI_SMART_ALPHABETIC_INPUT_METHODS__)&& defined(__MMI_LANG_MALAYALAM__))
	#ifndef __MMI_ZI_MALAYALAM__
	#define __MMI_ZI_MALAYALAM__
	#endif
#endif


#if defined(CFG_MMI_ZI_MARATHI) && ((CFG_MMI_ZI_MARATHI == __ON__)||(CFG_MMI_ZI_MARATHI == __AUTO__)) && \
	(defined(__MMI_ZI__) && defined(__MMI_SMART_ALPHABETIC_INPUT_METHODS__)&& defined(__MMI_LANG_MARATHI__) && defined(__MMI_ZI_V7__))
	#ifndef __MMI_ZI_MARATHI__
	#define __MMI_ZI_MARATHI__
	#endif
#endif


#if defined(CFG_MMI_ZI_MOLDOVAN) && ((CFG_MMI_ZI_MOLDOVAN == __ON__)||(CFG_MMI_ZI_MOLDOVAN == __AUTO__)) && \
	(defined(__MMI_ZI_V7__) && defined(__MMI_SMART_ALPHABETIC_INPUT_METHODS__)&& defined(__MMI_LANG_MOLDOVAN__))
	#ifndef __MMI_ZI_MOLDOVAN__
	#define __MMI_ZI_MOLDOVAN__
	#endif
#endif


#if defined(CFG_MMI_ZI_MULTITAP) && ((CFG_MMI_ZI_MULTITAP == __ON__)||(CFG_MMI_ZI_MULTITAP == __AUTO__)) && \
	(defined(__MMI_ZI__) && ( defined(__MMI_NORMAL_KEYPAD__)  || defined(__MMI_IME_ALPHANUMERIC_VK_SUPPORT__)))
	#ifndef __MMI_ZI_MULTITAP__
	#define __MMI_ZI_MULTITAP__
	#endif
#endif


#if defined(CFG_MMI_ZI_MULTITAP_PHONETIC_INPUT) && ((CFG_MMI_ZI_MULTITAP_PHONETIC_INPUT == __ON__)||(CFG_MMI_ZI_MULTITAP_PHONETIC_INPUT == __AUTO__)) && \
	(defined(__MMI_ZI__))
	#ifndef __MMI_ZI_MULTITAP_PHONETIC_INPUT__
	#define __MMI_ZI_MULTITAP_PHONETIC_INPUT__
	#endif
#endif


#if defined(CFG_MMI_ZI_NORWEGIAN) && ((CFG_MMI_ZI_NORWEGIAN == __ON__)||(CFG_MMI_ZI_NORWEGIAN == __AUTO__)) && \
	(defined(__MMI_ZI__) && defined(__MMI_SMART_ALPHABETIC_INPUT_METHODS__)&& defined(__MMI_LANG_NORWEGIAN__))
	#ifndef __MMI_ZI_NORWEGIAN__
	#define __MMI_ZI_NORWEGIAN__
	#endif
#endif


#if defined(CFG_MMI_ZI_PERSIAN) && ((CFG_MMI_ZI_PERSIAN == __ON__)||(CFG_MMI_ZI_PERSIAN == __AUTO__)) && \
	(defined(__MMI_ZI__) && defined(__MMI_SMART_ALPHABETIC_INPUT_METHODS__)&& defined(__MMI_LANG_PERSIAN__) && defined(__MMI_ZI_V7__))
	#ifndef __MMI_ZI_PERSIAN__
	#define __MMI_ZI_PERSIAN__
	#endif
#endif


#if defined(CFG_MMI_ZI_POLISH) && ((CFG_MMI_ZI_POLISH == __ON__)||(CFG_MMI_ZI_POLISH == __AUTO__)) && \
	(defined(__MMI_ZI__) && defined(__MMI_SMART_ALPHABETIC_INPUT_METHODS__)&& defined(__MMI_LANG_POLISH__))
	#ifndef __MMI_ZI_POLISH__
	#define __MMI_ZI_POLISH__
	#endif
#endif


#if defined(CFG_MMI_ZI_PRC_ENGLISH) && ((CFG_MMI_ZI_PRC_ENGLISH == __ON__)||(CFG_MMI_ZI_PRC_ENGLISH == __AUTO__)) && \
	(defined(__MMI_ZI__) && defined(__MMI_SMART_ALPHABETIC_INPUT_METHODS__)&& defined(__MMI_LANG_ENGLISH__))
	#ifndef __MMI_ZI_PRC_ENGLISH__
	#define __MMI_ZI_PRC_ENGLISH__
	#endif
#endif


#if defined(CFG_MMI_ZI_PUNJABI) && ((CFG_MMI_ZI_PUNJABI == __ON__)||(CFG_MMI_ZI_PUNJABI == __AUTO__)) && \
	(defined(__MMI_ZI__) && defined(__MMI_SMART_ALPHABETIC_INPUT_METHODS__)&& defined(__MMI_LANG_PUNJABI__) && defined(__MMI_ZI_V7__))
	#ifndef __MMI_ZI_PUNJABI__
	#define __MMI_ZI_PUNJABI__
	#endif
#endif


#if defined(CFG_MMI_ZI_ROMANIAN) && ((CFG_MMI_ZI_ROMANIAN == __ON__)||(CFG_MMI_ZI_ROMANIAN == __AUTO__)) && \
	(defined(__MMI_ZI__) && defined(__MMI_SMART_ALPHABETIC_INPUT_METHODS__)&& defined(__MMI_LANG_ROMANIAN__))
	#ifndef __MMI_ZI_ROMANIAN__
	#define __MMI_ZI_ROMANIAN__
	#endif
#endif


#if defined(CFG_MMI_ZI_RUSSIAN) && ((CFG_MMI_ZI_RUSSIAN == __ON__)||(CFG_MMI_ZI_RUSSIAN == __AUTO__)) && \
	(defined(__MMI_ZI__) && defined(__MMI_SMART_ALPHABETIC_INPUT_METHODS__)&& defined(__MMI_LANG_RUSSIAN__))
	#ifndef __MMI_ZI_RUSSIAN__
	#define __MMI_ZI_RUSSIAN__
	#endif
#endif


#if defined(CFG_MMI_ZI_SA_PORTUGUESE) && ((CFG_MMI_ZI_SA_PORTUGUESE == __ON__)||(CFG_MMI_ZI_SA_PORTUGUESE == __AUTO__)) && \
	(defined(__MMI_ZI__) && defined(__MMI_SMART_ALPHABETIC_INPUT_METHODS__) && defined(__MMI_LANG_SA_PORTUGUESE__))
	#ifndef __MMI_ZI_SA_PORTUGUESE__
	#define __MMI_ZI_SA_PORTUGUESE__
	#endif
#endif


#if defined(CFG_MMI_ZI_SA_SPANISH) && ((CFG_MMI_ZI_SA_SPANISH == __ON__)||(CFG_MMI_ZI_SA_SPANISH == __AUTO__)) && \
	(defined(__MMI_ZI__) && defined(__MMI_SMART_ALPHABETIC_INPUT_METHODS__) && defined(__MMI_LANG_SA_SPANISH__))
	#ifndef __MMI_ZI_SA_SPANISH__
	#define __MMI_ZI_SA_SPANISH__
	#endif
#endif


#if defined(CFG_MMI_ZI_SERBIAN) && ((CFG_MMI_ZI_SERBIAN == __ON__)||(CFG_MMI_ZI_SERBIAN == __AUTO__)) && \
	(defined(__MMI_ZI__) && defined(__MMI_SMART_ALPHABETIC_INPUT_METHODS__) && defined(__MMI_LANG_SERBIAN__))
	#ifndef __MMI_ZI_SERBIAN__
	#define __MMI_ZI_SERBIAN__
	#endif
#endif


#if defined(CFG_MMI_ZI_SLOVAK) && ((CFG_MMI_ZI_SLOVAK == __ON__)||(CFG_MMI_ZI_SLOVAK == __AUTO__)) && \
	(defined(__MMI_ZI__) && defined(__MMI_SMART_ALPHABETIC_INPUT_METHODS__)&& defined(__MMI_LANG_SLOVAK__))
	#ifndef __MMI_ZI_SLOVAK__
	#define __MMI_ZI_SLOVAK__
	#endif
#endif


#if defined(CFG_MMI_ZI_SLOVENIAN) && ((CFG_MMI_ZI_SLOVENIAN == __ON__)||(CFG_MMI_ZI_SLOVENIAN == __AUTO__)) && \
	(defined(__MMI_ZI__) && defined(__MMI_SMART_ALPHABETIC_INPUT_METHODS__)&& defined(__MMI_LANG_SLOVENIAN__))
	#ifndef __MMI_ZI_SLOVENIAN__
	#define __MMI_ZI_SLOVENIAN__
	#endif
#endif


#if defined(CFG_MMI_ZI_SMART_PHONETIC_INPUT) && ((CFG_MMI_ZI_SMART_PHONETIC_INPUT == __ON__)||(CFG_MMI_ZI_SMART_PHONETIC_INPUT == __AUTO__)) && \
	(defined(__MMI_ZI__) && defined(__MMI_SMART_PHONETIC_INPUT_METHODS__))
	#ifndef __MMI_ZI_SMART_PHONETIC_INPUT__
	#define __MMI_ZI_SMART_PHONETIC_INPUT__
	#endif
#endif


#if defined(CFG_MMI_ZI_STROKE_INPUT) && ((CFG_MMI_ZI_STROKE_INPUT == __ON__)||(CFG_MMI_ZI_STROKE_INPUT == __AUTO__)) && \
	(defined(__MMI_ZI__) && (defined(__MMI_NORMAL_KEYPAD__) || defined(__MMI_QWERTY_KEYPAD_SUPPORT__)|| defined(__MMI_IME_ALPHANUMERIC_VK_SUPPORT__)))
	#ifndef __MMI_ZI_STROKE_INPUT__
	#define __MMI_ZI_STROKE_INPUT__
	#endif
#endif


#if defined(CFG_MMI_ZI_SWAHILI) && ((CFG_MMI_ZI_SWAHILI == __ON__)||(CFG_MMI_ZI_SWAHILI == __AUTO__)) && \
	(defined(__MMI_ZI_V7__) && defined(__MMI_SMART_ALPHABETIC_INPUT_METHODS__)&& defined(__MMI_LANG_SWAHILI__))
	#ifndef __MMI_ZI_SWAHILI__
	#define __MMI_ZI_SWAHILI__
	#endif
#endif


#if defined(CFG_MMI_ZI_SWEDISH) && ((CFG_MMI_ZI_SWEDISH == __ON__)||(CFG_MMI_ZI_SWEDISH == __AUTO__)) && \
	(defined(__MMI_ZI__) && defined(__MMI_SMART_ALPHABETIC_INPUT_METHODS__)&& defined(__MMI_LANG_SWEDISH__))
	#ifndef __MMI_ZI_SWEDISH__
	#define __MMI_ZI_SWEDISH__
	#endif
#endif


#if defined(CFG_MMI_ZI_TAGALOG) && ((CFG_MMI_ZI_TAGALOG == __ON__)||(CFG_MMI_ZI_TAGALOG == __AUTO__)) && \
	(defined(__MMI_ZI__) && defined(__MMI_SMART_ALPHABETIC_INPUT_METHODS__) && defined(__MMI_LANG_TAGALOG__))
	#ifndef __MMI_ZI_TAGALOG__
	#define __MMI_ZI_TAGALOG__
	#endif
#endif


#if defined(CFG_MMI_ZI_TAMIL) && ((CFG_MMI_ZI_TAMIL == __ON__)||(CFG_MMI_ZI_TAMIL == __AUTO__)) && \
	(defined(__MMI_ZI__) && defined(__MMI_SMART_ALPHABETIC_INPUT_METHODS__)&& defined(__MMI_LANG_TAMIL__) && defined(__MMI_ZI_V7__))
	#ifndef __MMI_ZI_TAMIL__
	#define __MMI_ZI_TAMIL__
	#endif
#endif


#if defined(CFG_MMI_ZI_TELUGU) && ((CFG_MMI_ZI_TELUGU == __ON__)||(CFG_MMI_ZI_TELUGU == __AUTO__)) && \
	(defined(__MMI_ZI__) && defined(__MMI_SMART_ALPHABETIC_INPUT_METHODS__)&& defined(__MMI_LANG_TELUGU__) && defined(__MMI_ZI_V7__))
	#ifndef __MMI_ZI_TELUGU__
	#define __MMI_ZI_TELUGU__
	#endif
#endif


#if defined(CFG_MMI_ZI_THAI) && ((CFG_MMI_ZI_THAI == __ON__)||(CFG_MMI_ZI_THAI == __AUTO__)) && \
	(defined(__MMI_ZI__) && defined(__MMI_SMART_ALPHABETIC_INPUT_METHODS__)&& defined(__MMI_LANG_THAI__))
	#ifndef __MMI_ZI_THAI__
	#define __MMI_ZI_THAI__
	#endif
#endif


#if defined(CFG_MMI_ZI_TURKISH) && ((CFG_MMI_ZI_TURKISH == __ON__)||(CFG_MMI_ZI_TURKISH == __AUTO__)) && \
	(defined(__MMI_ZI__) && defined(__MMI_SMART_ALPHABETIC_INPUT_METHODS__)&& defined(__MMI_LANG_TURKISH__))
	#ifndef __MMI_ZI_TURKISH__
	#define __MMI_ZI_TURKISH__
	#endif
#endif


#if defined(CFG_MMI_ZI_UK_ENGLISH) && ((CFG_MMI_ZI_UK_ENGLISH == __ON__)||(CFG_MMI_ZI_UK_ENGLISH == __AUTO__)) && \
	(defined(__MMI_ZI__) && defined(__MMI_SMART_ALPHABETIC_INPUT_METHODS__) && defined(__MMI_LANG_UK_ENGLISH__))
	#ifndef __MMI_ZI_UK_ENGLISH__
	#define __MMI_ZI_UK_ENGLISH__
	#endif
#endif


#if defined(CFG_MMI_ZI_UKRAINIAN) && ((CFG_MMI_ZI_UKRAINIAN == __ON__)||(CFG_MMI_ZI_UKRAINIAN == __AUTO__)) && \
	(defined(__MMI_ZI__) && defined(__MMI_SMART_ALPHABETIC_INPUT_METHODS__)&& defined(__MMI_LANG_UKRAINIAN__) && defined(__MMI_ZI_V7__))
	#ifndef __MMI_ZI_UKRAINIAN__
	#define __MMI_ZI_UKRAINIAN__
	#endif
#endif


#if defined(CFG_MMI_ZI_URDU) && ((CFG_MMI_ZI_URDU == __ON__)||(CFG_MMI_ZI_URDU == __AUTO__)) && \
	(defined(__MMI_ZI__) && defined(__MMI_SMART_ALPHABETIC_INPUT_METHODS__)&& defined(__MMI_LANG_URDU__) && defined(__MMI_ZI_V7__))
	#ifndef __MMI_ZI_URDU__
	#define __MMI_ZI_URDU__
	#endif
#endif


#if defined(CFG_MMI_ZI_USING_PSCRATCH_BUFFER) && ((CFG_MMI_ZI_USING_PSCRATCH_BUFFER == __ON__)||(CFG_MMI_ZI_USING_PSCRATCH_BUFFER == __AUTO__)) && \
	(defined(__MMI_ZI__) && !defined(LOW_COST_SUPPORT) &&  !defined(__MMI_ZI_V7__) && (defined(__MMI_ZI_SM_CHINESE__) || defined(__MMI_ZI_TR_CHINESE__)))
	#ifndef __MMI_ZI_USING_PSCRATCH_BUFFER__
	#define __MMI_ZI_USING_PSCRATCH_BUFFER__
	#endif
#endif


#if defined(CFG_MMI_ZI_VIETNAMESE) && ((CFG_MMI_ZI_VIETNAMESE == __ON__)||(CFG_MMI_ZI_VIETNAMESE == __AUTO__)) && \
	(defined(__MMI_ZI__) && defined(__MMI_SMART_ALPHABETIC_INPUT_METHODS__)&& defined(__MMI_LANG_VIETNAMESE__))
	#ifndef __MMI_ZI_VIETNAMESE__
...
#if defined(WGUI_STATUS_ICON_SHOW_V_BAR)
	#define WGUI_STATUS_ICON_SHOW_V_BAR
#elif defined(__WGUI_STATUS_ICON_NO_SHOW_V_BAR__)
	#ifdef WGUI_STATUS_ICON_SHOW_V_BAR
	#undef WGUI_STATUS_ICON_SHOW_V_BAR
	#endif
#endif

#if 0
#if (!defined(__MMI_FWUI_SLIM__))&&!defined(__WGUI_STATUS_ICON_NO_SHOW_V_BAR__)
...
#if defined(CFG_SSC_RESTORE_SETTING) && ((CFG_SSC_RESTORE_SETTING == __ON__)||(CFG_SSC_RESTORE_SETTING == __AUTO__))
	#ifndef __SSC_RESTORE_SETTING__
	#define __SSC_RESTORE_SETTING__
	#endif
#endif


/*精简版拼图游戏*/
#if defined(CFG_MMI_SLIM_PUZZLE_GAME) && ((CFG_MMI_SLIM_PUZZLE_GAME == __ON__)||(CFG_MMI_SLIM_PUZZLE_GAME == __AUTO__))
	#ifndef __SLIM_PUZZLE_GAME__
	#define __SLIM_PUZZLE_GAME__
	#endif
#endif

#if defined(__SLIM_PUZZLE_GAME__)
  #define __MMI_GAME__
  #define __MMI_GAME_PUZZLE__
#else
  #if defined(CFG_MMI_GAME_MENU) && ((CFG_MMI_GAME_MENU == __ON__)||(CFG_MMI_GAME_MENU == __AUTO__)) && \
  ...
  /*拼图游戏*/
  #if defined(CFG_MMI_GAME_PUZZLE) && ((CFG_MMI_GAME_PUZZLE == __ON__)||(CFG_MMI_GAME_PUZZLE == __AUTO__)) && \
      (defined(__MMI_GAME__) && (defined(__MMI_MAINLCD_128X128__) || defined(__MMI_MAINLCD_128X160__) || \
      defined(__MMI_MAINLCD_160X128__)|| defined(__MMI_MAINLCD_176X220__)  || defined(__MMI_MAINLCD_220X176__) || \
      defined(__MMI_MAINLCD_240X320__) || defined(__MMI_MAINLCD_240X400__) || defined(__MMI_MAINLCD_320X240__) || \
      defined(__MMI_MAINLCD_320X480__)))
  	#ifndef __MMI_GAME_PUZZLE__
  	#define __MMI_GAME_PUZZLE__
  	#endif
...
#if defined(CFG_MMI_GAME_MULTICHANNEL_SOUND) && ((CFG_MMI_GAME_MULTICHANNEL_SOUND == __ON__)||(CFG_MMI_GAME_MULTICHANNEL_SOUND == __AUTO__)) && \
	(defined(__MMI_GAME__))
...
#if defined(CFG_MMI_STOPWATCH) && ((CFG_MMI_STOPWATCH == __ON__)||(CFG_MMI_STOPWATCH == __AUTO__))
	#ifndef __MMI_STOPWATCH__
	#define __MMI_STOPWATCH__
	#endif
#endif

#if defined(__SPICE_MMI_STYLE__) ||defined(__L39_160X128_YST__)
	#ifndef __SLIM_MEDIA_SHOW_VOL_ADJUST_ICON__
	#define __SLIM_MEDIA_SHOW_VOL_ADJUST_ICON__
	#endif
#endif

//lh added 20120611 开机logo白色背景
#if defined(CFG_MMI_DISPLAY_LOGO_WITH_WHITE_BACKGROUND) && ((CFG_MMI_DISPLAY_LOGO_WITH_WHITE_BACKGROUND == __ON__)||(CFG_MMI_DISPLAY_LOGO_WITH_WHITE_BACKGROUND == __AUTO__))
    #ifndef __MMI_DISPLAY_LOGO_WITH_WHITE_BACKGROUND__
    #define __MMI_DISPLAY_LOGO_WITH_WHITE_BACKGROUND__
    #endif
#endif

/**************************************************************************
	自定义开关机LOGO背景色
	需要自己添加定义GDI_COLOR_CUSTOMIZE_FOR_LOGO     的颜色值

***************************************************************************/
#if defined(CFG_MMI_DISPLAY_LOGO_WITH_CUSTOMIZE_COLOR) && ((CFG_MMI_DISPLAY_LOGO_WITH_CUSTOMIZE_COLOR == __ON__)||(CFG_MMI_DISPLAY_LOGO_WITH_CUSTOMIZE_COLOR == __AUTO__))
    #ifndef __MMI_DISPLAY_LOGO_WITH_CUSTOMIZE_COLOR__
    #define __MMI_DISPLAY_LOGO_WITH_CUSTOMIZE_COLOR__
    #endif
#endif

//add by YZHD 20130522 拨号语音
#if defined(CFG_MMI_HUMAN_VOICE_KEYPAD_TONE) && ((CFG_MMI_HUMAN_VOICE_KEYPAD_TONE == __ON__)||(CFG_MMI_HUMAN_VOICE_KEYPAD_TONE == __AUTO__)) && \
	(defined(DIGIT_TONE_SUPPORT))
	#ifndef __MMI_HUMAN_VOICE_KEYPAD_TONE__
	#define __MMI_HUMAN_VOICE_KEYPAD_TONE__
	#endif
#endif

//add by YZHD 20130522 来电报号与电话簿报号
#if defined(CFG_MMI_INTELLIGENT_CALL_ALERT) && ((CFG_MMI_INTELLIGENT_CALL_ALERT == __ON__)||(CFG_MMI_INTELLIGENT_CALL_ALERT == __AUTO__)) && \
	(defined(DIGIT_TONE_SUPPORT) || defined(SIMPLE_TTS))
	#ifndef __MMI_INTELLIGENT_CALL_ALERT__
	#define __MMI_INTELLIGENT_CALL_ALERT__
	#endif
#endif

//add by songfeng    长按键切换keypad tone type(人声音调)开关
#if defined(__KEYPAD_HUMAN_TONE_SWITCH__)
    #define __KEYPAD_HUMAN_TONE_SWITCH__
#endif

//add by songfeng   长按键切换电话簿报号(名)开关
#if defined(__SPEAK_PHONEBOOK_AND_INCOME_NUMBER_SWITCH__)
    #define __SPEAK_PHONEBOOK_AND_INCOME_NUMBER_SWITCH__
#endif

//add by songfeng   FM界面只留左右搜索图标，长按#切换搜索类型。
#if defined(__FM_SEARCH_ONEKEY_SWITCH__)
    #define __FM_SEARCH_ONEKEY_SWITCH__
#endif


/* 自动选择语言 */
#if defined(CFG_MMI_AUTO_LANG_EN) && ((CFG_MMI_AUTO_LANG_EN == __ON__)||(CFG_MMI_AUTO_LANG_EN == __AUTO__))
	#ifndef __MMI_AUTO_LANG_EN__
	#define __MMI_AUTO_LANG_EN__
	#endif
#endif

//add by songfeng   5秒后自动锁屏
#if defined(__SLK_SETTING_5_SEC__)
    #define __SLK_SETTING_5_SEC__
#endif

#if defined(__L39_SL_200__)||defined(__F303_YST_F12__)||defined(__L39_60M_SL_1000_220x176_GSM__)//SL200加设置菜单，但宏里的一些功能有差异
    #if defined(__MMI_SOS_CALL_SETTING__)
	#define __SL200_SOS_REQ__
    #endif
#endif

//songfeng idle农历滚动显示
#if defined(__IDLE_CHINESE_CALENDAR__)
    #if defined(__F303_YST_F12__)
       #ifndef __IDLE_LUNAR_SCROLL__
       #define __IDLE_LUNAR_SCROLL__  
       #endif
    #endif
#endif


#if defined(__BYT_SWITCH_MUTILANG_TEMPLATE__) && !defined(_MUTILANG_TEMPLATE_)//添加报错机制YZHD 20130917
	#error "please turn on _MUTILANG_TEMPLATE_ "
#endif

#if (defined(__TIMEKEEPING_FUNC__) && !defined(__MMI_HUMAN_VOICE_KEYPAD_TONE__)&& !defined(DIGIT_TONE_SUPPORT))
	#error "It should turn on __MMI_HUMAN_VOICE_KEYPAD_TONE__ or DIGIT_TONE_SUPPORT or SIMPLE_TTS"
#endif
