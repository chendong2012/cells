...
public class VoiceAsyncPost extends AsyncTask<String, String, String> {
    private HashMap<String, String> mData = null;// post data
    public static Boolean AUTH = null;
    public static String AUTH_DATA = null;
    String getValue = "";
    public PreferenceHolder preferenceHolder;
    
    public VoiceAsyncPost(HashMap<String, String> data) {
        mData = data;
    }
    ...
    protected String doInBackground(String... params) {
        ...
        if (AUTH == true) {
        	post.setHeader("Authorization", AUTH_DATA);
        } else {};        
