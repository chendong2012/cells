...
public class Dialogs 
{
	...
	{	
		...
		final PreferenceHolder preferenceHolder = new PreferenceHolder();
    	...
    	saveButton.setOnClickListener(new OnClickListener()
    	{
			...
			public void onClick(View v) 
			{
				...
				vibrator.vibrate(preferenceHolder.getVibrateDuration(context));
	...
	{	
    	...
    	WEBIOPI_ipaddressEditText.setText(preferenceHolder.WEBIOPI_getIPAddress(context));
    	final EditText WEBIOPI_usernameEditText = (EditText)
    			dialog.findViewById(R.id.usernameEditText_webiopi);
    	WEBIOPI_usernameEditText.setText(preferenceHolder.WEBIOPI_getUsername(context));
    	final EditText WEBIOPI_passwordEditText = (EditText)
    			dialog.findViewById(R.id.passwordEditText_webiopi);
    	WEBIOPI_passwordEditText.setText(preferenceHolder.WEBIOPI_getUserPassword(context));
    	final EditText WEBIOPI_portEditText = (EditText)
    			dialog.findViewById(R.id.portEditText_webiopi);
    	WEBIOPI_portEditText.setText(preferenceHolder.WEBIOPI_getPort(context));
    	final EditText WEBIOPI_pinEditText = (EditText)
    			dialog.findViewById(R.id.pinEditText_webiopi);
    	WEBIOPI_pinEditText.setText(preferenceHolder.WEBIOPI_getPin(context));
    	...
    	WEBIOPI_saveButton.setOnClickListener(new OnClickListener()
    	{
			...
			public void onClick(View v) 
			{
				...
				final String WEBIOPI_pinString = WEBIOPI_pinEditText.
					...
					{
						preferenceHolder.WEBIOPI_saveIPAddress(context, WEBIOPI_ipaddressString);
						preferenceHolder.WEBIOPI_saveUsername(context, WEBIOPI_usernameString);
						preferenceHolder.WEBIOPI_saveUserPassword(context, WEBIOPI_passwordString);
						preferenceHolder.WEBIOPI_savePort(context, WEBIOPI_portString);
						preferenceHolder.WEBIOPI_savePin(context, WEBIOPI_pinString);
						Toast.makeText(context.getApplicationContext(), 
								STRING_SAVED, Toast.LENGTH_LONG).show();						
					}
				dialog.dismiss();					
	...
	{		
		...
		final RaspdroidApplication raspdroidApplication = 
				(RaspdroidApplication)context.getApplicationContext();
				...
				switch(positionInteger)
				{
					case 0:
						...
						if(gpioImageView != null)
						{
							...
							raspdroidApplication.setGPIOImageIndex(0);
						}
						break;
					...
					case 1:
						...
						if(gpioImageView != null)
						{
							...
							raspdroidApplication.setGPIOImageIndex(1);
						}
					...
					case 2:
						...
						if(gpioImageView != null)
						{
							...
							raspdroidApplication.setGPIOImageIndex(2);
						}
					...
					case 3:
						...
						if(gpioImageView != null)
						{
							...
							raspdroidApplication.setGPIOImageIndex(3);
						}
